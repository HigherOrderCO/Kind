...
module.exports = (function() {
    ...
    function App$KL$Game$Phase$Draft$draw$cards$player$(_hero$1) {
        ...
        switch (self._) {
            case 'Pair.new':
                var $1074 = self.fst;
                var $1075 = self.snd;
                var $1076 = App$KL$Game$Phase$Draft$draw$cards$card$($1074, $1075, "100%");
                var $1064 = $1076;
                break;
        };
        return $1064;
    ...
    function App$KL$Game$Phase$Draft$draw$cards$picks_left$(_hero$1) {
        var $1077 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "40%"), List$cons$(Pair$new$("height", "100%"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("padding", "5%"), List$cons$(Pair$new$("box-sizing", "border-box"), List$nil)))))), List$cons$(App$KL$Game$Phase$Draft$draw$cards$player$(_hero$1), List$nil));
        return $1077;
    };
    ...
    function App$KL$Game$Phase$Draft$draw$cards$ally$(_user$1, _info$2) {
        ...
        switch (self._) {
            case 'Maybe.some':
                ...
                break;
            case 'Maybe.none':
                var $1724 = Pair$new$("Connecting", App$KL$Game$Phase$Draft$draw$cards$interrogation);
                var self = $1724;
                break;
        };
        switch (self._) {
            case 'Pair.new':
                var $1725 = self.fst;
                var $1726 = self.snd;
                var $1727 = App$KL$Game$Phase$Draft$draw$cards$card$($1725, $1726, "80%");
                var $1708 = $1727;
                break;
        };
        return $1708;
    ...
    function App$KL$Game$Phase$Draft$draw$cards$allies$(_map$1, _team$2) {
        ...
        var _dom$8 = Nat$for$(_dom$7, 0n, _count$6, (_i$8 => _dom$9 => {
            var $1738 = List$cons$(App$KL$Game$Phase$Draft$draw$cards$ally$("none", Maybe$none), _dom$9);
            return $1738;
        }));
        var _dom$9 = (() => {
            var $1740 = _dom$8;
            ...
            while ($1741._ === 'List.cons') {
                _pair$9 = $1741.head;
                var $1740 = List$cons$(App$KL$Game$Phase$Draft$draw$cards$ally$((() => {
                    var self = _pair$9;
                    switch (self._) {
                        case 'Pair.new':
                            var $1742 = self.fst;
    ...
    function App$KL$Game$Phase$Draft$draw$cards$(_players$1, _user$2) {
        ...
        var $1748 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "70%"), List$cons$(Pair$new$("height", "100%"), List$cons$(Pair$new$("display", "flex"), List$nil)))), List$cons$(App$KL$Game$Phase$Draft$draw$cards$picks_left$(_hero$6), List$cons$(App$KL$Game$Phase$Draft$draw$cards$picks_right$(_allies$5, _team$3), List$nil)));
        return $1748;
    };
    ...
    function App$KL$Game$Phase$Draft$draw$top$(_players$1, _user$2) {
        ...
        var $1754 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "100%"), List$cons$(Pair$new$("height", "60%"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("background-image", _color$4), List$cons$(Pair$new$("align-items", "center"), List$cons$(Pair$new$("justify-content", "center"), List$nil))))))), List$cons$(DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "100%"), List$cons$(Pair$new$("max-width", "1440px"), List$cons$(Pair$new$("height", "100%"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("background-image", _color$4), List$cons$(Pair$new$("align-items", "center"), List$cons$(Pair$new$("justify-content", "center"), List$nil)))))))), List$cons$(App$KL$Game$Phase$Draft$draw$coordinates$(_players$1, _user$2), List$cons$(App$KL$Game$Phase$Draft$draw$cards$(_players$1, _user$2), List$nil))), List$nil));
        return $1754;
    };
    ...
    function App$KL$Game$Phase$Draft$draw$choose_team$(_players$1) {
        var $1803 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "60%"), List$cons$(Pair$new$("height", "30%"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("flex-direction", "row"), List$cons$(Pair$new$("justify-content", "space-between"), List$nil)))))), List$cons$(App$KL$Game$Phase$Draft$draw$choose_team$button$(_players$1, App$KL$Game$Team$blue), List$cons$(App$KL$Game$Phase$Draft$draw$choose_team$button$(_players$1, App$KL$Game$Team$red), List$nil)));
        return $1803;
    };
        ...
        switch (self._) {
            case 'App.KL.Global.State.new':
                ...
                switch (self._) {
                    case 'Maybe.some':
                        var $1817 = self.value;
                        var $1818 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "100vw"), List$cons$(Pair$new$("height", "100vh"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("justify-content", "center"), List$cons$(Pair$new$("align-items", "center"), List$nil)))))), List$cons$(App$KL$Game$Phase$Draft$draw$main$((() => {
                            var self = $1817;
                            switch (self._) {
    ...
    function Word$show$(_size$1, _a$2) {
        ...
        var $1826 = (Nat$show$(_n$3) + ("#" + Nat$show$(_size$1)));
        return $1826;
    };
    ...
    function App$KL$Game$Phase$Play$draw$tile$terrain$indicator$(_tile_coord$1, _mouse_coord$2, _preview$3) {
        ...
        switch (self._) {
            case 'App.KL.Game.Cast.Preview.new':
                var $1869 = self.areas;
                var self = Hexagonal$Axial$BBL$get$(_tile_coord$1, $1869);
                switch (self._) {
                    case 'Maybe.some':
                        var $1871 = self.value;
                        var $1872 = $1871;
    ...
    function Hexagonal$Axial$to_screen_xy$(_coord$1, _radius$2, _center_x$3, _center_y$4) {
        ...
        switch (self._) {
            case 'Hexagonal.Axial.new':
                ...
                var _cy$20 = ((_cy$17 >>> 0));
                var $1877 = Pair$new$(_cx$18, _cy$20);
                var $1874 = $1877;
                break;
        };
        return $1874;
    ...
    function App$KL$Game$Phase$Play$draw$centralize$(_coord$1) {
        ...
        switch (self._) {
            case 'Pair.new':
                ...
                var _i$5 = (($1879 - _aux$4) >>> 0);
                var _j$6 = (($1880 - _aux$4) >>> 0);
                var $1881 = Pair$new$(_i$5, _j$6);
                var $1878 = $1881;
                break;
        };
        return $1878;
        ...
        var _draw$2 = (_terrain$2 => _indicator$3 => {
            ...
            switch (self._) {
                case 'App.KL.Game.Indicator.green':
                    var $1885 = App$Kaelin$Assets$tile$green_1;
                    var $1884 = $1885;
                    break;
                case 'App.KL.Game.Indicator.red':
                case 'App.KL.Game.Indicator.yellow':
                    var $1886 = App$Kaelin$Assets$tile$effect$light_red2;
                    var $1884 = $1886;
                    break;
                case 'App.KL.Game.Indicator.blue':
                    var $1887 = App$Kaelin$Assets$tile$effect$dark_blue2;
                    var $1884 = $1887;
                    break;
                case 'App.KL.Game.Indicator.background':
                    var $1888 = App$Kaelin$Assets$tile$green_2;
                    var $1884 = $1888;
                    break;
            };
            return $1884;
        });
        var $1883 = App$KL$Game$Field$new$(_name$1, _draw$2);
        return $1883;
    })();
    ...
    function Array$get$(_idx$3, _arr$4) {
        var $1895 = Word$foldl$(Array$extract_tip, (_rec$6 => _arr$7 => {
            var _arr_l$8 = Array$extract_tie$(_arr$7);
            var self = _arr_l$8;
            switch (self._) {
                case 'Pair.new':
                    var $1897 = self.fst;
                    var $1898 = _rec$6($1897);
                    var $1896 = $1898;
                    break;
            };
            return $1896;
                ...
                var $1904 = (_b$6 => {
                    ...
                    switch (self._) {
                        case 'Word.o':
                            var $1906 = self.pred;
                            var $1907 = (_a$pred$9 => {
                                var $1908 = Word$o$(Word$and$(_a$pred$9, $1906));
                                return $1908;
                            });
                            var $1905 = $1907;
                            break;
                        case 'Word.i':
                            var $1909 = self.pred;
                            var $1910 = (_a$pred$9 => {
                                var $1911 = Word$o$(Word$and$(_a$pred$9, $1909));
                                return $1911;
                            });
                            var $1905 = $1910;
                            break;
                ...
                var $1915 = (_b$6 => {
                    ...
                    switch (self._) {
                        case 'Word.o':
                            var $1917 = self.pred;
                            var $1918 = (_a$pred$9 => {
                                var $1919 = Word$o$(Word$and$(_a$pred$9, $1917));
                                return $1919;
                            });
                            var $1916 = $1918;
                            break;
                        case 'Word.i':
                            var $1920 = self.pred;
                            var $1921 = (_a$pred$9 => {
                                var $1922 = Word$i$(Word$and$(_a$pred$9, $1920));
                                return $1922;
                            });
                            var $1916 = $1921;
                            break;
    ...
    function VoxBox$Draw$image$(_x$1, _y$2, _z$3, _src$4, _img$5) {
        ...
        var _img$7 = (() => {
            ...
            var $1930 = _len$6;
            let _img$8 = $1928;
            for (let _i$7 = $1929; _i$7 < $1930; ++_i$7) {
                ...
                var $1928 = ((_img$8.buffer[_img$8.length * 2] = _pos$17, _img$8.buffer[_img$8.length * 2 + 1] = _col$10, _img$8.length++, _img$8));
                _img$8 = $1928;
            };
            return _img$8;
        })();
    ...
    function List$indices$u32$(_xs$2) {
        var $1936 = List$imap$((_i$3 => _x$4 => {
            var $1937 = Pair$new$((Number(_i$3) >>> 0), _x$4);
            return $1937;
        }), _xs$2);
        return $1936;
    };
    ...
    function String$to_list$(_str$1) {
        ...
        if (self.length === 0) {
            ...
            var $1940 = self.charCodeAt(0);
            var $1941 = self.slice(1);
            var $1942 = List$cons$($1940, String$to_list$($1941));
            var $1938 = $1942;
        };
        return $1938;
    };
    ...
    function Bits$to_nat$(_b$1) {
        ...
        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
            case 'o':
                ...
                var $1945 = (2n * Bits$to_nat$($1944));
                var $1943 = $1945;
                break;
            case 'i':
                var $1946 = self.slice(0, -1);
                var $1947 = Nat$succ$((2n * Bits$to_nat$($1946)));
                var $1943 = $1947;
                break;
            case 'e':
                var $1948 = 0n;
    ...
    function Word$to_bits$(_a$2) {
        ...
        switch (self._) {
            case 'Word.o':
                var $1950 = self.pred;
                var $1951 = (Word$to_bits$($1950) + '0');
                var $1949 = $1951;
                break;
            case 'Word.i':
                var $1952 = self.pred;
                var $1953 = (Word$to_bits$($1952) + '1');
                var $1949 = $1953;
                break;
            case 'Word.e':
                var $1954 = Bits$e;
    ...
    function U16$show_hex$(_a$1) {
        ...
        switch ('u16') {
            case 'u16':
                var $1956 = u16_to_word(self);
                var $1957 = Nat$to_string_base$(16n, Bits$to_nat$(Word$to_bits$($1956)));
                var $1955 = $1957;
                break;
        };
        return $1955;
    ...
    function VoxBox$Draw$text$char$(_chr$1, _font_map$2, _chr_pos$3, _scr$4) {
        ...
        switch (self._) {
            case 'Maybe.some':
                ...
                var $1964 = VoxBox$Draw$image$(_x$6, _y$7, _z$8, $1963, _scr$4);
                var $1962 = $1964;
                break;
            case 'Maybe.none':
                var $1965 = _scr$4;
    ...
    function Pos32$add$(_a$1, _b$2) {
        ...
        var $1966 = ((0 | _x$3 | (_y$4 << 12) | (_z$5 << 24)));
        return $1966;
    };
    ...
    function VoxBox$Draw$text$(_txt$1, _font_map$2, _pos$3, _scr$4) {
        var _scr$5 = (() => {
            var $1969 = _scr$4;
            var $1970 = List$indices$u32$(String$to_list$(_txt$1));
            let _scr$6 = $1969;
            let _pair$5;
            while ($1970._ === 'List.cons') {
                _pair$5 = $1970.head;
                var self = _pair$5;
                switch (self._) {
                    case 'Pair.new':
                        var $1971 = self.fst;
                        var $1972 = self.snd;
                        var _add_pos$9 = ((0 | (($1971 * 6) >>> 0) | (0 << 12) | (0 << 24)));
                        var $1973 = VoxBox$Draw$text$char$($1972, _font_map$2, Pos32$add$(_pos$3, _add_pos$9), _scr$6);
                        var $1969 = $1973;
                        break;
                };
                _scr$6 = $1969;
    ...
    function Char$to_string$(_chr$1) {
        var $1974 = String$cons$(_chr$1, String$nil);
        return $1974;
    };
    const Char$to_string = x0 => Char$to_string$(x0);

    function PixelFont$set_img$(_char$1, _img$2, _map$3) {
        var $1975 = Map$set$(U16$show_hex$(_char$1), _img$2, _map$3);
        return $1975;
    };
    ...
    function App$KL$Game$Phase$Play$draw$letter$(_tile_coord$1, _preview$2, _img$3) {
        ...
        switch (self._) {
            case 'App.KL.Game.Cast.Preview.new':
                var $1978 = self.picks;
                var self = Hexagonal$Axial$BBL$get$(_tile_coord$1, $1978);
                switch (self._) {
                    case 'Maybe.some':
                        var $1980 = self.value;
                        ...
                        switch (self._) {
                            case 'Pair.new':
                                var $1982 = self.fst;
                                var $1983 = self.snd;
                                var $1984 = VoxBox$Draw$text$(Char$to_string$($1980), PixelFont$black, ((0 | $1982 | ($1983 << 12) | (0 << 24))), _img$3);
                                var $1981 = $1984;
                                break;
                        };
                        var $1979 = $1981;
            ...
            case 'Maybe.some':
                ...
                switch (self._) {
                    case 'Pair.new':
                        ...
                        var _drawing$8 = _drawing$8($1995);
                        var _aux$9 = I32$to_u32$(App$KL$Constants$hexagon_radius);
                        var _cy$10 = (($1998 - ((_aux$9 * 2) >>> 0)) >>> 0);
                        var _cx$11 = (($1997 - _aux$9) >>> 0);
                        ...
                        var _img$11 = App$KL$Game$Phase$Play$draw$tile$terrain$((() => {
                            ...
                            switch (self._) {
                                case 'App.KL.Game.Tile.new':
                                    var $2012 = self.terrain;
                                    var $2013 = $2012;
                                    return $2013;
                            };
                        })(), _preview$2, $2009, _mouse_coord$6, _img$8);
                        var _img$12 = App$KL$Game$Phase$Play$draw$tile$creature$((() => {
                            var self = $2010;
                            switch (self._) {
                                case 'App.KL.Game.Tile.new':
                                    var $2014 = self.creature;
                                    var $2015 = $2014;
                                    return $2015;
                            };
                        })(), $2009, _img$11);
    ...
    function App$KL$Game$Phase$Play$draw$cursor$(_mouse$1, _img$2) {
        ...
        switch (self._) {
            case 'Pair.new':
                var $2017 = self.fst;
                var $2018 = self.snd;
                var $2019 = VoxBox$Draw$image$($2017, $2018, 0, App$Kaelin$Assets$tile$mouse_ui, _img$2);
                var $2016 = $2019;
                break;
        };
        return $2016;
    ...
    function App$KL$Game$Phase$Play$draw$(_img$1, _local$2, _game$3) {
        var $2029 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "100vw"), List$cons$(Pair$new$("height", "100vh"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("flex-direction", "column"), List$cons$(Pair$new$("justify-content", "center"), List$cons$(Pair$new$("align-items", "center"), List$cons$(Pair$new$("position", "relative"), List$nil)))))))), List$cons$(DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$(DOM$text$(("Time: " + ((() => {
            var self = _game$3;
            switch (self._) {
                case 'App.KL.Game.new':
                    var $2030 = self.tick;
        ...
        })() + "#64"))), List$nil)), List$cons$(DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$((() => {
            ...
            var $2032 = DOM$vbox$(Map$from_list$(List$cons$(Pair$new$("id", "game_screen"), List$cons$(Pair$new$("width", _width$4), List$cons$(Pair$new$("height", _height$5), List$cons$(Pair$new$("scale", "2"), List$nil))))), Map$from_list$(List$nil), App$KL$Game$Phase$Play$draw$canvas$(_img$1, _local$2, _game$3));
            return $2032;
        })(), List$nil)), List$nil)));
        return $2029;
    };
    ...
    function App$KL$Game$draw$(_img$1, _local$2, _global$3) {
        var $2033 = DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$((() => {
            var self = _global$3;
            switch (self._) {
                case 'App.KL.Global.State.new':
                    var $2035 = self.game;
            ...
            switch (self._) {
                case 'Maybe.some':
                    var $2037 = self.value;
                    var $2038 = DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$((() => {
                        var self = $2037;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2040 = self.phase;
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Phase.draft':
                                var $2042 = App$KL$Game$Phase$Draft$draw$(_local$2, _global$3);
                                var $2039 = $2042;
                                break;
                            case 'App.KL.Game.Phase.play':
                                var $2043 = App$KL$Game$Phase$Play$draw$(_img$1, _local$2, $2037);
                                var $2039 = $2043;
                                break;
                        };
                        return $2039;
                    ...
                    break;
                case 'Maybe.none':
                    var $2044 = DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$(DOM$text$("Not ingame."), List$nil));
                    var $2034 = $2044;
                    break;
            };
            return $2034;
    ...
    function App$KL$draw$(_img$1, _state$2) {
        ...
        switch (self._) {
            case 'App.Store.new':
                var $2046 = self.local;
                var $2047 = self.global;
                var self = $2046;
                switch (self._) {
                    case 'App.KL.State.Local.lobby':
                        var $2049 = self.state;
                        var $2050 = App$KL$Lobby$draw$($2049, $2047);
                        var $2048 = $2050;
                        break;
                    case 'App.KL.State.Local.game':
                        var $2051 = self.state;
                        var $2052 = App$KL$Game$draw$(_img$1, $2051, $2047);
                        var $2048 = $2052;
                        break;
                };
                var $2045 = $2048;
    ...
    function String$map$(_f$1, _as$2) {
        ...
        if (self.length === 0) {
            ...
            var $2056 = self.charCodeAt(0);
            var $2057 = self.slice(1);
            var $2058 = String$cons$(_f$1($2056), String$map$(_f$1, $2057));
            var $2054 = $2058;
        };
        return $2054;
    };
    ...
    function String$to_lower$(_str$1) {
        var $2062 = String$map$(Char$to_lower, _str$1);
        return $2062;
    };
    ...
    function IO$bind$(_a$3, _f$4) {
        ...
        switch (self._) {
            ...
            case 'IO.ask':
                ...
                var $2068 = self.param;
                var $2069 = self.then;
                var $2070 = IO$ask$($2067, $2068, (_x$8 => {
                    var $2071 = IO$bind$($2069(_x$8), _f$4);
                    return $2071;
                }));
                var $2064 = $2070;
                break;
    ...
    function IO$monad$(_new$2) {
        var $2073 = _new$2(IO$bind)(IO$end);
        return $2073;
    };
    const IO$monad = x0 => IO$monad$(x0);

    function App$set_local$(_value$2) {
        var $2074 = IO$monad$((_m$bind$3 => _m$pure$4 => {
            var $2075 = _m$pure$4;
            return $2075;
        }))(Maybe$some$(_value$2));
        return $2074;
    ...
    const IO$get_time = IO$ask$("get_time", "", (_time$1 => {
        var $2077 = IO$end$((BigInt(_time$1)));
        return $2077;
    }));
    ...
    function Nat$random$(_seed$1) {
        ...
        var $2078 = (((_seed$1 * _m$2) + _i$3) % _q$4);
        return $2078;
    };
    const Nat$random = x0 => Nat$random$(x0);

    function IO$random$(_a$1) {
        var $2079 = IO$monad$((_m$bind$2 => _m$pure$3 => {
            var $2080 = _m$bind$2;
            return $2080;
        }))(IO$get_time)((_seed$2 => {
            var _seed$3 = Nat$random$(_seed$2);
            var $2081 = IO$monad$((_m$bind$4 => _m$pure$5 => {
                var $2082 = _m$pure$5;
                return $2082;
            }))((_seed$3 % _a$1));
            return $2081;
            ...
            var R = (() => {
                ...
                if (self === 0n) {
                    ...
                    if (self.length === 0) {
                        ...
                        var $2087 = self.charCodeAt(0);
                        var $2088 = self.slice(1);
                        var $2089 = String$drop$($2084, $2088);
                        var $2085 = $2089;
                    };
                    return $2085;
                };
        ...
        while (true) {
            ...
            var R = (() => {
                ...
                if (self.length === 0) {
                    ...
                    var $2091 = self.charCodeAt(0);
                    var $2092 = self.slice(1);
                    var $2093 = String$length$go$($2092, Nat$succ$(_n$2));
                    return $2093;
                };
            })();
            if (R.ctr === 'TCO') arg = R.arg;
    ...
    function String$length$(_xs$1) {
        var $2094 = String$length$go$(_xs$1, 0n);
        return $2094;
    };
    const String$length = x0 => String$length$(x0);

    function IO$do$(_call$1, _param$2) {
        var $2095 = IO$ask$(_call$1, _param$2, (_answer$3 => {
            var $2096 = IO$end$(Unit$new);
            return $2096;
        }));
        return $2095;
    };
    ...
    function App$do$(_call$2, _param$3) {
        var $2097 = IO$monad$((_m$bind$4 => _m$pure$5 => {
            var $2098 = _m$bind$4;
            return $2098;
    ...
    function String$take$(_n$1, _xs$2) {
        ...
        if (self.length === 0) {
            ...
            var $2106 = self.charCodeAt(0);
            var $2107 = self.slice(1);
            var self = _n$1;
            if (self === 0n) {
                var $2109 = String$nil;
                var $2108 = $2109;
                ...
                var $2110 = (self - 1n);
                var $2111 = String$cons$($2106, String$take$($2110, $2107));
                var $2108 = $2111;
            };
            var $2104 = $2108;
        };
    ...
    function String$pad_right$(_size$1, _chr$2, _str$3) {
        ...
        if (self === 0n) {
            ...
            var self = _str$3;
            if (self.length === 0) {
                var $2116 = String$cons$(_chr$2, String$pad_right$($2114, _chr$2, ""));
                var $2115 = $2116;
            } else {
                var $2117 = self.charCodeAt(0);
                var $2118 = self.slice(1);
                var $2119 = String$cons$($2117, String$pad_right$($2114, _chr$2, $2118));
                var $2115 = $2119;
            };
            var $2112 = $2115;
        };
    ...
    function String$pad_right_exact$(_size$1, _chr$2, _str$3) {
        var $2120 = String$take$(_size$1, String$pad_right$(_size$1, _chr$2, _str$3));
        return $2120;
    };
            ...
            case 'o':
                ...
                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                    case 'o':
                        ...
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'o':
                                var $2126 = self.slice(0, -1);
                                var self = $2126;
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        var $2128 = self.slice(0, -1);
                                        var $2129 = ("0" + Bits$hex$encode$($2128));
                                        var $2127 = $2129;
                                        break;
                                    case 'i':
                                        var $2130 = self.slice(0, -1);
                                        var $2131 = ("8" + Bits$hex$encode$($2130));
                                        var $2127 = $2131;
                                        break;
                                    case 'e':
                                        var $2132 = "0";
                            ...
                            case 'i':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2136 = ("4" + Bits$hex$encode$($2135));
                                        var $2134 = $2136;
                                        break;
                                    case 'i':
                                        var $2137 = self.slice(0, -1);
                                        var $2138 = ("c" + Bits$hex$encode$($2137));
                                        var $2134 = $2138;
                                        break;
                                    case 'e':
                                        var $2139 = "4";
                            ...
                            case 'o':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2146 = ("2" + Bits$hex$encode$($2145));
                                        var $2144 = $2146;
                                        break;
                                    case 'i':
                                        var $2147 = self.slice(0, -1);
                                        var $2148 = ("a" + Bits$hex$encode$($2147));
                                        var $2144 = $2148;
                                        break;
                                    case 'e':
                                        var $2149 = "2";
                            ...
                            case 'i':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2153 = ("6" + Bits$hex$encode$($2152));
                                        var $2151 = $2153;
                                        break;
                                    case 'i':
                                        var $2154 = self.slice(0, -1);
                                        var $2155 = ("e" + Bits$hex$encode$($2154));
                                        var $2151 = $2155;
                                        break;
                                    case 'e':
                                        var $2156 = "6";
            ...
            case 'i':
                ...
                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            ...
                            case 'o':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2166 = ("1" + Bits$hex$encode$($2165));
                                        var $2164 = $2166;
                                        break;
                                    case 'i':
                                        var $2167 = self.slice(0, -1);
                                        var $2168 = ("9" + Bits$hex$encode$($2167));
                                        var $2164 = $2168;
                                        break;
                                    case 'e':
                                        var $2169 = "1";
                            ...
                            case 'i':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2173 = ("5" + Bits$hex$encode$($2172));
                                        var $2171 = $2173;
                                        break;
                                    case 'i':
                                        var $2174 = self.slice(0, -1);
                                        var $2175 = ("d" + Bits$hex$encode$($2174));
                                        var $2171 = $2175;
                                        break;
                                    case 'e':
                                        var $2176 = "5";
                    ...
                    case 'i':
                        ...
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'o':
                                var $2180 = self.slice(0, -1);
                                var self = $2180;
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        var $2182 = self.slice(0, -1);
                                        var $2183 = ("3" + Bits$hex$encode$($2182));
                                        var $2181 = $2183;
                                        break;
                                    case 'i':
                                        var $2184 = self.slice(0, -1);
                                        var $2185 = ("b" + Bits$hex$encode$($2184));
                                        var $2181 = $2185;
                                        break;
                                    case 'e':
                                        var $2186 = "3";
                            ...
                            case 'i':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2190 = ("7" + Bits$hex$encode$($2189));
                                        var $2188 = $2190;
                                        break;
                                    case 'i':
                                        var $2191 = self.slice(0, -1);
                                        var $2192 = ("f" + Bits$hex$encode$($2191));
                                        var $2188 = $2192;
                                        break;
                                    case 'e':
                                        var $2193 = "7";
    ...
    function Serializer$run$(_serializer$2, _x$3) {
        var $2197 = _serializer$2(_x$3)(Bits$e);
        return $2197;
    };
    ...
    function Word$serializer$(_w$2, _bs$3) {
        ...
        switch (self._) {
            case 'Word.o':
                var $2203 = self.pred;
                var $2204 = (Word$serializer$($2203, _bs$3) + '0');
                var $2202 = $2204;
                break;
            case 'Word.i':
                var $2205 = self.pred;
                var $2206 = (Word$serializer$($2205, _bs$3) + '1');
                var $2202 = $2206;
                break;
            case 'Word.e':
                var $2207 = _bs$3;
    ...
    function U8$serializer$(_x$1, _bs$2) {
        ...
        switch ('u8') {
            case 'u8':
                var $2209 = u8_to_word(self);
                var $2210 = Word$serializer$($2209, _bs$2);
                var $2208 = $2210;
                break;
        };
        return $2208;
    ...
    function I32$serializer$(_x$1, _bs$2) {
        ...
        switch ('i32') {
            case 'i32':
                var $2212 = i32_to_word(self);
                var $2213 = Word$serializer$($2212, _bs$2);
                var $2211 = $2213;
                break;
        };
        return $2211;
    ...
    function Hexagonal$Axial$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'Hexagonal.Axial.new':
                var $2215 = self.i;
                var $2216 = self.j;
                var $2217 = I32$serializer$($2215, I32$serializer$($2216, _bs$2));
                var $2214 = $2217;
                break;
        };
        return $2214;
    ...
    function App$KL$Game$Phase$Draft$Event$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.Phase.Draft.Event.set_team':
                var $2219 = self.team;
                var $2220 = (((App$KL$Game$Team$serializer$($2219, _bs$2) + '0') + '0') + '1');
                var $2218 = $2220;
                break;
            case 'App.KL.Game.Phase.Draft.Event.set_hero':
                var $2221 = self.hero;
                var $2222 = (((U8$serializer$($2221, _bs$2) + '0') + '1') + '0');
                var $2218 = $2222;
                break;
            case 'App.KL.Game.Phase.Draft.Event.set_init_pos':
                var $2223 = self.coord;
                var $2224 = (((Hexagonal$Axial$serializer$($2223, _bs$2) + '0') + '1') + '1');
                var $2218 = $2224;
                break;
            case 'App.KL.Game.Phase.Draft.Event.set_ready':
                var $2225 = self.ready;
                var $2226 = (((U8$serializer$($2225, _bs$2) + '1') + '0') + '0');
                var $2218 = $2226;
                break;
            case 'App.KL.Game.Phase.Draft.Event.join_room':
                var $2227 = (((_bs$2 + '0') + '0') + '0');
                var $2218 = $2227;
                break;
        };
        return $2218;
    ...
    function U16$serializer$(_x$1, _bs$2) {
        ...
        switch ('u16') {
            case 'u16':
                var $2229 = u16_to_word(self);
                var $2230 = Word$serializer$($2229, _bs$2);
                var $2228 = $2230;
                break;
        };
        return $2228;
    ...
    function App$KL$Game$Phase$Play$Event$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.Phase.Play.Event.cast':
                var $2232 = self.letter;
                var $2233 = self.target;
                var $2234 = Char$serializer($2232)(Hexagonal$Axial$serializer$($2233, _bs$2));
                var $2231 = $2234;
                break;
        };
        return $2231;
    ...
    function App$KL$Game$Event$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.Event.draft':
                var $2236 = self.event;
                var $2237 = (App$KL$Game$Phase$Draft$Event$serializer$($2236, _bs$2) + '0');
                var $2235 = $2237;
                break;
            case 'App.KL.Game.Event.play':
                var $2238 = self.event;
                var $2239 = (App$KL$Game$Phase$Play$Event$serializer$($2238, _bs$2) + '1');
                var $2235 = $2239;
                break;
        };
        return $2235;
    ...
    function App$KL$Global$Event$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'App.KL.Global.Event.game':
                var $2241 = self.event;
                var $2242 = (App$KL$Game$Event$serializer$($2241, _bs$2) + '1');
                var $2240 = $2242;
                break;
    ...
    function App$KL$Global$Event$serialize_post$(_ev$1) {
        var $2244 = ("0x" + String$pad_right_exact$(64n, 48, Bits$hex$encode$(Serializer$run$(App$KL$Global$Event$serializer, _ev$1))));
        return $2244;
    };
    ...
    function App$KL$Game$State$Local$init$(_user$1, _room$2) {
        ...
        var $2250 = App$KL$Game$State$Local$new$(_user$1, _room$2, _preview$3, _mouse$4);
        return $2250;
    };
        ...
        switch (self._) {
            case 'App.Event.init':
                ...
                switch (self._) {
                    case 'App.KL.Lobby.State.Local.new':
                        ...
                        var $2255 = App$KL$Lobby$State$Local$new$(String$to_lower$($2252), $2254);
                        var _new_local$7 = $2255;
                        break;
                };
                var $2253 = App$set_local$(App$KL$State$Local$lobby$(_new_local$7));
                var $2251 = $2253;
                break;
            case 'App.Event.mouse_click':
                var $2256 = self.id;
                var self = ($2256 === "random");
                if (self) {
                    var $2258 = IO$monad$((_m$bind$7 => _m$pure$8 => {
                        ...
                        switch (self._) {
                            case 'App.KL.Lobby.State.Local.new':
                                var $2261 = self.user;
                                var $2262 = App$KL$Lobby$State$Local$new$($2261, _room$9);
                                var _new_local$10 = $2262;
                                break;
                        };
                        var $2260 = App$set_local$(App$KL$State$Local$lobby$(_new_local$10));
                        return $2260;
                    }));
                    var $2257 = $2258;
                } else {
                    var self = ($2256 === "ready");
                    if (self) {
                        var $2264 = IO$monad$((_m$bind$7 => _m$pure$8 => {
                            var $2265 = _m$bind$7;
                            return $2265;
                        }))(App$watch$((() => {
                            var self = _local$1;
                            switch (self._) {
                                case 'App.KL.Lobby.State.Local.new':
                                    var $2266 = self.room_input;
                                    var $2267 = $2266;
                                    return $2267;
                            };
                        })()))((_$7 => {
                            var $2268 = IO$monad$((_m$bind$8 => _m$pure$9 => {
                                var $2269 = _m$bind$8;
                                return $2269;
                            }))(App$new_post$((() => {
                                var self = _local$1;
                                switch (self._) {
                                    case 'App.KL.Lobby.State.Local.new':
                                        var $2270 = self.room_input;
                                        var $2271 = $2270;
                                        return $2271;
                                };
                            })(), App$KL$Game$Phase$Draft$Event$join_room$serial))((_$8 => {
                                var $2272 = App$set_local$(App$KL$State$Local$game$(App$KL$Game$State$Local$init$((() => {
                                    var self = _local$1;
                                    switch (self._) {
                                        case 'App.KL.Lobby.State.Local.new':
                                            var $2273 = self.user;
            ...
            case 'App.Event.input':
                ...
                switch (self._) {
                    case 'App.KL.Lobby.State.Local.new':
                        var $2280 = self.user;
                        var $2281 = App$KL$Lobby$State$Local$new$($2280, $2278);
                        var _new_local$7 = $2281;
                        break;
                };
                var $2279 = App$set_local$(App$KL$State$Local$lobby$(_new_local$7));
                var $2251 = $2279;
                break;
        ...
        while (true) {
            ...
            var R = (() => {
                ...
                if (self.length === 0) {
                    ...
                    var $2285 = self.charCodeAt(0);
                    var $2286 = self.slice(1);
                    var self = _xs$1;
                    if (self.length === 0) {
                        var $2288 = Bool$false;
                        var $2287 = $2288;
                    } else {
                        var $2289 = self.charCodeAt(0);
                        var $2290 = self.slice(1);
                        var self = Char$eql$($2285, $2289);
                        if (self) {
                            var $2292 = String$starts_with$($2290, $2286);
                            var $2291 = $2292;
                        } else {
                            var $2293 = Bool$false;
                            var $2291 = $2293;
    ...
    function Word$mod$(_a$2, _b$3) {
        ...
        var $2294 = Word$sub$(_a$2, Word$mul$(_b$3, _q$4));
        return $2294;
    };
    ...
    function Hexagonal$Axial$from_nat$(_n$1) {
        ...
        var $2295 = Hexagonal$Axial$new$(_coord_i$5, _coord_j$8);
        return $2295;
    };
    ...
    function App$KL$Game$Phase$Draft$Event$set_init_pos$serial$(_coord$1) {
        var $2297 = App$KL$Global$Event$serialize_post$(App$KL$Global$Event$game$(App$KL$Game$Event$draft$(App$KL$Game$Phase$Draft$Event$set_init_pos$(_coord$1))));
        return $2297;
    };
    ...
    function App$KL$Game$Hero$name_to_id$(_name$1) {
        var $2301 = Map$get$(_name$1, App$KL$Game$Hero$name_to_id$map);
        return $2301;
    };
    ...
    function App$KL$Game$Phase$Draft$Event$set_hero$serial$(_hero$1) {
        var $2303 = App$KL$Global$Event$serialize_post$(App$KL$Global$Event$game$(App$KL$Game$Event$draft$(App$KL$Game$Phase$Draft$Event$set_hero$(_hero$1))));
        return $2303;
    };
    ...
    function App$KL$Game$Phase$Draft$Event$set_ready$serial$(_ready$1) {
        var $2305 = App$KL$Global$Event$serialize_post$(App$KL$Global$Event$game$(App$KL$Game$Event$draft$(App$KL$Game$Phase$Draft$Event$set_ready$(_ready$1))));
        return $2305;
    };
    ...
    function App$KL$Game$Phase$Draft$Event$set_team$serial$(_team$1) {
        var $2307 = App$KL$Global$Event$serialize_post$(App$KL$Global$Event$game$(App$KL$Game$Event$draft$(App$KL$Game$Phase$Draft$Event$set_team$(_team$1))));
        return $2307;
    };
    ...
    function App$KL$Game$Phase$Draft$when$(_local$1, _global$2, _event$3) {
        ...
        switch (self._) {
            case 'App.Event.mouse_click':
                var $2311 = self.id;
                var self = String$starts_with$($2311, "C");
                if (self) {
                    var _coord_nat$8 = String$drop$(1n, $2311);
                    var _coord$9 = Hexagonal$Axial$from_nat$((BigInt(_coord_nat$8)));
                    var $2313 = App$new_post$((() => {
                        var self = _local$1;
                        switch (self._) {
                            case 'App.KL.Game.State.Local.new':
                                var $2314 = self.room;
                    ...
                    var self = String$starts_with$($2311, "H");
                    if (self) {
                        var _hero_name$8 = String$drop$(1n, $2311);
                        var _hero_id$9 = Maybe$map$(Nat$to_u8, App$KL$Game$Hero$name_to_id$(_hero_name$8));
                        var self = _hero_id$9;
                        switch (self._) {
                            case 'Maybe.some':
                                var $2318 = self.value;
                                var $2319 = App$new_post$((() => {
                                    var self = _local$1;
                                    switch (self._) {
                                        case 'App.KL.Game.State.Local.new':
                                            var $2320 = self.room;
                                ...
                                })(), App$KL$Game$Phase$Draft$Event$set_hero$serial$($2318));
                                var $2317 = $2319;
                                break;
                            case 'Maybe.none':
                                var $2322 = App$pass;
                        ...
                        var self = String$starts_with$($2311, "R");
                        if (self) {
                            ...
                            switch (self._) {
                                case 'Maybe.some':
                                    ...
                                    if (self) {
                                        var $2331 = 0;
                                        var _ready_u8$10 = $2331;
                                    } else {
                                        var $2332 = 1;
                                        var _ready_u8$10 = $2332;
                                    };
                                    var $2328 = App$new_post$((() => {
                                        var self = _local$1;
                                        switch (self._) {
                                            case 'App.KL.Game.State.Local.new':
                                                var $2333 = self.room;
                            ...
                            var self = String$starts_with$($2311, "T");
                            if (self) {
                                var _player_count$8 = String$drop$(1n, $2311);
                                ...
                                if (self) {
                                    ...
                                    if (self) {
                                        var $2340 = App$KL$Game$Team$blue;
                                        var _team$10 = $2340;
                                    } else {
                                        var self = (_team$9 === "red");
                                        if (self) {
                                            var $2342 = App$KL$Game$Team$red;
                                            var $2341 = $2342;
                                        } else {
                                            var $2343 = App$KL$Game$Team$neutral;
                                            var $2341 = $2343;
                                        };
                                        var _team$10 = $2341;
                                    };
                                    var $2339 = App$new_post$((() => {
                                        var self = _local$1;
                                        switch (self._) {
                                            case 'App.KL.Game.State.Local.new':
                                                var $2344 = self.room;
    ...
    function Hexagonal$Axial$BBL$insert$(_key$2, _val$3, _map$4) {
        var $2348 = BBL$insert$(Hexagonal$Axial$cmp, _key$2, _val$3, _map$4);
        return $2348;
    };
    ...
    function App$KL$Game$Cast$picks_of$(_player$1, _casts$2) {
        ...
        var _map$4 = (() => {
            ...
            let _map$5 = $2351;
            let _cast$4;
            while ($2352._ === 'List.cons') {
                _cast$4 = $2352.head;
                var self = _cast$4;
                switch (self._) {
                    case 'App.KL.Game.Cast.new':
                        var $2353 = self.player;
                        var $2354 = self.target;
                        var $2355 = self.letter;
                        var self = (_player$1 === $2353);
                        if (self) {
                            var $2357 = Hexagonal$Axial$BBL$insert$($2354, $2355, _map$5);
                            var $2356 = $2357;
                        } else {
                            var $2358 = _map$5;
                            var $2356 = $2358;
    ...
    function Hexagonal$Axial$BBL$from_list$(_list$2) {
        var $2359 = BBL$from_list$(Hexagonal$Axial$cmp, _list$2);
        return $2359;
    };
    ...
    function App$KL$Game$Phase$Play$Event$cast$serial$(_letter$1, _target$2) {
        var $2362 = App$KL$Global$Event$serialize_post$(App$KL$Global$Event$game$(App$KL$Game$Event$play$(App$KL$Game$Phase$Play$Event$cast$(_letter$1, _target$2))));
        return $2362;
    };
    ...
    function App$KL$Game$Phase$Play$when$(_local$1, _game$2, _event$3) {
        ...
        switch (self._) {
            case 'App.Event.key_down':
                var $2364 = self.code;
                var $2365 = ((console.log(("Key down " + Char$to_string$($2364))), (_$6 => {
                    var $2366 = ((console.log("Setting casts."), (_$7 => {
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Cast.Preview.new':
                                var $2372 = self.picks;
                                var $2373 = App$KL$Game$Cast$Preview$new$(Hexagonal$Axial$BBL$from_list$(List$cons$(Pair$new$(_coord$8, App$KL$Game$Indicator$blue), List$nil)), $2372);
                                var _preview$10 = $2373;
                                break;
                        };
                        var $2367 = App$set_local$(App$KL$State$Local$game$((() => {
                            var self = _local$1;
                            switch (self._) {
                                case 'App.KL.Game.State.Local.new':
                                    var $2374 = self.user;
                                    var $2375 = self.room;
                                    var $2376 = self.mouse;
                                    var $2377 = App$KL$Game$State$Local$new$($2374, $2375, _preview$10, $2376);
                                    return $2377;
                            };
                        })()));
                        return $2367;
            ...
            case 'App.Event.key_up':
                ...
                switch (self._) {
                    case 'App.KL.Game.Cast.Preview.new':
                        var $2384 = self.picks;
                        var $2385 = App$KL$Game$Cast$Preview$new$(Hexagonal$Axial$BBL$from_list$(List$nil), $2384);
                        var _preview$8 = $2385;
                        break;
                };
                var $2379 = IO$monad$((_m$bind$9 => _m$pure$10 => {
                    var $2386 = _m$bind$9;
                    return $2386;
                }))(App$new_post$((() => {
                    var self = _local$1;
                ...
                })(), App$KL$Game$Phase$Play$Event$cast$serial$($2378, _coord$6)))((_$9 => {
                    var $2389 = App$set_local$(App$KL$State$Local$game$((() => {
                        var self = _local$1;
                        switch (self._) {
                            case 'App.KL.Game.State.Local.new':
                                var $2390 = self.user;
                                var $2391 = self.room;
                                var $2392 = self.mouse;
                                var $2393 = App$KL$Game$State$Local$new$($2390, $2391, _preview$8, $2392);
                                return $2393;
                        };
                    })()));
                    return $2389;
            ...
            case 'App.Event.mouse_move':
                var $2394 = self.id;
                var $2395 = self.mouse_pos;
                var self = ("game_screen" === $2394);
                if (self) {
                    var self = $2395;
                    switch (self._) {
                        case 'Pair.new':
                            var $2398 = self.fst;
                            var $2399 = self.snd;
                            var $2400 = App$set_local$(App$KL$State$Local$game$((() => {
                                var self = _local$1;
                                switch (self._) {
                                    case 'App.KL.Game.State.Local.new':
                                        var $2401 = self.user;
                                        var $2402 = self.room;
                                        var $2403 = self.preview;
                                        var $2404 = App$KL$Game$State$Local$new$($2401, $2402, $2403, Pair$new$((($2398 / 2) >>> 0), (($2399 / 2) >>> 0)));
                                        return $2404;
                                };
                            })()));
                            var $2397 = $2400;
            ...
            case 'App.Event.frame':
                ...
                switch (self._) {
                    case 'App.KL.Game.State.Local.new':
                        ...
                        var $2413 = self.room;
                        var $2414 = self.mouse;
                        var $2415 = App$KL$Game$State$Local$new$($2412, $2413, (() => {
                            var self = _local$1;
                            switch (self._) {
                                case 'App.KL.Game.State.Local.new':
                                    var $2416 = self.preview;
                                    var $2417 = $2416;
                                    var self = $2417;
                                    break;
                            };
                            switch (self._) {
                                case 'App.KL.Game.Cast.Preview.new':
                                    var $2418 = self.areas;
                                    var $2419 = App$KL$Game$Cast$Preview$new$($2418, _picks$6);
                                    return $2419;
                            };
                        })(), $2414);
                        var _preview$7 = $2415;
                ...
                var $2407 = ((console.log(("ue " + Nat$show$((list_length(Hexagonal$Axial$BBL$to_list$((() => {
                    var self = _local$1;
                    switch (self._) {
                        case 'App.KL.Game.State.Local.new':
                            var $2420 = self.preview;
                            var $2421 = $2420;
                            var self = $2421;
                            break;
                    };
                    ...
                    var $2424 = App$set_local$(App$KL$State$Local$game$(_preview$7));
                    return $2424;
                })()));
                var $2363 = $2407;
                break;
                    ...
                    case 'Maybe.some':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.new':
                                ...
                                switch (self._) {
                                    case 'App.KL.Game.Phase.draft':
                                        var $2432 = App$KL$Game$Phase$Draft$when$(_local$1, $2428, _event$3);
                                        var $2431 = $2432;
                                        break;
                                    case 'App.KL.Game.Phase.play':
                                        var $2433 = App$KL$Game$Phase$Play$when$(_local$1, $2428, _event$3);
                                        var $2431 = $2433;
                                        break;
                                };
                                var $2429 = $2431;
    ...
    function App$KL$when$(_event$1, _state$2) {
        ...
        switch (self._) {
            case 'App.Store.new':
                var $2436 = self.local;
                var $2437 = self.global;
                var self = $2436;
                switch (self._) {
                    case 'App.KL.State.Local.lobby':
                        var $2439 = self.state;
                        var $2440 = App$KL$Lobby$when$($2439, $2437, _event$1);
                        var $2438 = $2440;
                        break;
                    case 'App.KL.State.Local.game':
                        var $2441 = self.state;
                        var $2442 = App$KL$Game$when$($2441, $2437, _event$1);
                        var $2438 = $2442;
                        break;
                };
                var $2435 = $2438;
    ...
    function Hexagonal$Axial$to_cubic$(_coord$1) {
        ...
        switch (self._) {
            case 'Hexagonal.Axial.new':
                ...
                var _z$5 = $2449;
                var _y$6 = ((((-_x$4)) - _z$5) >> 0);
                var $2450 = Hexagonal$Cubic$new$(_x$4, _y$6, _z$5);
                var $2447 = $2450;
                break;
        };
        return $2447;
    ...
    function Hexagonal$Axial$inside$(_coord$1, _region_size$2) {
        ...
        switch (self._) {
            case 'Hexagonal.Cubic.new':
                ...
                var $2453 = self.y;
                var $2454 = self.z;
                var _x$7 = I32$abs$($2452);
                var _y$8 = I32$abs$($2453);
                var _z$9 = I32$abs$($2454);
                var _greater$10 = I32$max$(_x$7, I32$max$(_y$8, _z$9));
                var $2455 = (_greater$10 <= _region_size$2);
                var $2451 = $2455;
                break;
        };
        return $2451;
    ...
    function App$KL$Game$Board$get$(_coord$1, _board$2) {
        var $2456 = Hexagonal$Axial$BBL$get$(_coord$1, _board$2);
        return $2456;
    };
    ...
    function App$KL$Game$Board$set$(_coord$1, _tile$2, _board$3) {
        var $2458 = Hexagonal$Axial$BBL$insert$(_coord$1, _tile$2, _board$3);
        return $2458;
    };
        ...
        switch (self._) {
                    ...
                    case 'App.KL.Game.Tile.new':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Entity.creature':
                                ...
                                switch (self._) {
                                    case 'App.KL.Game.Tile.new':
                                        var $2465 = self.terrain;
                                        var $2466 = App$KL$Game$Tile$new$($2465, Maybe$some$($2463));
                                        var _creature_tile$9 = $2466;
                                        break;
                                };
                                var $2464 = App$KL$Game$Board$set$(_coord$1, _creature_tile$9, _board$3);
                                var $2462 = $2464;
                                break;
                            case 'App.KL.Game.Entity.terrain':
                                ...
                                switch (self._) {
                                    case 'App.KL.Game.Tile.new':
                                        var $2468 = self.terrain;
                                        var $2469 = self.creature;
                                        var $2470 = App$KL$Game$Tile$new$($2468, $2469);
                                        var _background_tile$9 = $2470;
                                        break;
                                };
                                var $2467 = App$KL$Game$Board$set$(_coord$1, _background_tile$9, _board$3);
                                var $2462 = $2467;
                                break;
                        };
                        var $2461 = $2462;
            ...
            case 'Maybe.none':
                ...
                switch (self._) {
                    case 'App.KL.Game.Entity.terrain':
                        var $2472 = self.value;
                        var _new_tile$6 = App$KL$Game$Tile$new$($2472, Maybe$none);
                        var $2473 = App$KL$Game$Board$set$(_coord$1, _new_tile$6, _board$3);
                        var $2471 = $2473;
                        break;
                    case 'App.KL.Game.Entity.creature':
                        var $2474 = _board$3;
    ...
    const App$KL$Game$Board$arena = (() => {
        ...
        var _board$9 = (() => {
            ...
            var $2478 = _height$6;
            let _board$10 = $2476;
            for (let _j$9 = $2477; _j$9 < $2478; ++_j$9) {
                var _board$11 = (() => {
                    var $2479 = _board$10;
                    var $2480 = 0;
                    var $2481 = _width$4;
                    let _board$12 = $2479;
                    for (let _i$11 = $2480; _i$11 < $2481; ++_i$11) {
                        ...
                        var self = _inside$16;
                        if (self) {
                            var $2482 = App$KL$Game$Board$push$(_coord$15, _new_terrain$8, _board$12);
                            var $2479 = $2482;
                        } else {
                            var $2483 = _board$12;
                            var $2479 = $2483;
    ...
    function App$KL$Game$Phase$Draft$Hero$info$(_id$1) {
        var $2484 = App$KL$Game$Hero$get_by_id$((BigInt(_id$1)));
        return $2484;
    };
    ...
    function App$KL$Game$Phase$Draft$Tile$create_creature$(_hero_id$1, _player_addr$2, _team$3) {
        ...
        switch (self._) {
            case 'Maybe.some':
                var $2487 = self.value;
                var $2488 = Maybe$some$(App$KL$Game$Creature$new$(_player_addr$2, $2487, _team$3, (() => {
                    var self = $2487;
                    switch (self._) {
                        case 'App.KL.Game.Hero.new':
                            var $2489 = self.max_hp;
                            var $2490 = $2489;
                            return $2490;
                    };
                })(), (() => {
    ...
    function App$KL$Game$Phase$Draft$create_board$(_players$1) {
        var $2495 = ((console.log(" - criando mapa"), (_$2 => {
            ...
            var _map$5 = (() => {
                ...
                while ($2499._ === 'List.cons') {
                    ...
                    switch (self._) {
                        case 'App.KL.Game.Player.new':
                            var $2504 = self.init_pos;
                            var $2505 = $2504;
                            var _pos$9 = $2505;
                            break;
                    };
                    var $2498 = Maybe$default$(Maybe$monad$((_m$bind$10 => _m$pure$11 => {
                        var $2506 = _m$bind$10;
                        return $2506;
                    }))(_pos$9)((_coord$10 => {
                        var $2507 = Maybe$monad$((_m$bind$11 => _m$pure$12 => {
                            var $2508 = _m$bind$11;
                            return $2508;
                        }))(Maybe$map$(Nat$to_u8, (() => {
                            var self = _player$8;
                            ...
                            var $2511 = Maybe$monad$((_m$bind$13 => _m$pure$14 => {
                                var $2514 = _m$bind$13;
                                return $2514;
                                ...
                                var $2515 = Maybe$monad$((_m$bind$15 => _m$pure$16 => {
                                    var $2516 = _m$pure$16;
                                    return $2516;
    ...
    function App$KL$Game$Phase$Draft$tick$(_tick$1, _game$2) {
        ...
        switch (self._) {
            ...
            case 'List.cons':
                var self = _ready$5;
                if (self) {
                    var $2527 = ((console.log("- to_board"), (_$8 => {
                        var self = _game$2;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2529 = self.tick;
                                ...
                                var $2531 = self.board;
                                var $2532 = self.casts;
                                var $2533 = App$KL$Game$new$($2529, App$KL$Game$Phase$play, $2530, $2531, $2532);
                                var _game$9 = $2533;
                                break;
                        };
                        var self = _game$9;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2534 = self.tick;
                                var $2535 = self.phase;
                                var $2536 = self.players;
                                var $2537 = self.casts;
                                var $2538 = App$KL$Game$new$($2534, $2535, $2536, App$KL$Game$Phase$Draft$create_board$(_players$3), $2537);
                                var _game$10 = $2538;
                                break;
                        };
                        var $2528 = _game$10;
    ...
    function App$KL$Game$Phase$Play$tick$(_tick$1, _game$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.new':
                var $2541 = self.phase;
                var $2542 = self.players;
                var $2543 = self.board;
                var $2544 = self.casts;
                var $2545 = App$KL$Game$new$((((() => {
                    var self = _game$2;
                    switch (self._) {
                        case 'App.KL.Game.new':
                            var $2546 = self.tick;
                ...
                })() + 1n) & 0xFFFFFFFFFFFFFFFFn), $2541, $2542, $2543, $2544);
                var $2540 = $2545;
                break;
        };
        return $2540;
    ...
    function App$KL$Game$tick$(_tick$1, _game$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.new':
                ...
                switch (self._) {
                    case 'App.KL.Game.Phase.draft':
                        var $2551 = App$KL$Game$Phase$Draft$tick$(_tick$1, _game$2);
                        var $2550 = $2551;
                        break;
                    case 'App.KL.Game.Phase.play':
                        var $2552 = App$KL$Game$Phase$Play$tick$(_tick$1, _game$2);
                        var $2550 = $2552;
                        break;
                };
                var $2548 = $2550;
    ...
    function App$KL$Global$tick$(_tick$1, _glob$2) {
        ...
        switch (self._) {
            case 'Maybe.some':
                ...
                switch (self._) {
                    case 'App.KL.Global.State.new':
                        var $2558 = App$KL$Global$State$new$(Maybe$some$(App$KL$Game$tick$(_tick$1, $2556)));
                        var $2557 = $2558;
                        break;
                };
                var $2553 = $2557;
                            ...
                            case 'Maybe.some':
                                ...
                                switch (self._) {
                                    case 'Pair.new':
                                        var $2572 = self.fst;
                                        var $2573 = self.snd;
                                        var $2574 = Maybe$some$(Pair$new$($2572, $2573));
                                        var $2571 = $2574;
                                        break;
                                };
                                var $2569 = $2571;
                                break;
                            case 'Maybe.none':
                                var $2575 = Deserializer$choice$go$($2568, _bs$3);
                                var $2569 = $2575;
                                break;
                        };
                        return $2569;
    ...
    function Deserializer$choice$(_pars$2) {
        var $2577 = Deserializer$choice$go(_pars$2);
        return $2577;
    };
    ...
    function Deserializer$bits$(_bits$1, _bs$2) {
        ...
        while (true) {
            ...
            var R = (() => {
                ...
                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                    case 'o':
                        var $2586 = self.slice(0, -1);
                        var self = _bs$2;
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'o':
                                var $2588 = self.slice(0, -1);
                                var $2589 = Deserializer$bits$($2586, $2588);
                                var $2587 = $2589;
                                break;
                            case 'e':
                            case 'i':
                        ...
                        return $2587;
                    case 'i':
                        var $2591 = self.slice(0, -1);
                        var self = _bs$2;
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'i':
                                var $2593 = self.slice(0, -1);
                                var $2594 = Deserializer$bits$($2591, $2593);
                                var $2592 = $2594;
                                break;
                            case 'e':
                            case 'o':
                        ...
                        return $2592;
                    case 'e':
                        var $2596 = Maybe$some$(Pair$new$(_bs$2, Unit$new));
                        return $2596;
                };
            })();
            if (R.ctr === 'TCO') arg = R.arg;
    ...
    function Deserializer$pure$(_value$2, _bs$3) {
        var $2597 = Maybe$some$(Pair$new$(_bs$3, _value$2));
        return $2597;
    };
    ...
    const App$KL$Game$Team$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits(((Bits$e + '0') + '0')))((_$1 => {
        var $2598 = Deserializer$pure(App$KL$Game$Team$blue);
        return $2598;
    })), List$cons$(Deserializer$bind(Deserializer$bits(((Bits$e + '0') + '1')))((_$1 => {
        var $2599 = Deserializer$pure(App$KL$Game$Team$red);
        return $2599;
    })), List$cons$(Deserializer$bind(Deserializer$bits(((Bits$e + '1') + '0')))((_$1 => {
        var $2600 = Deserializer$pure(App$KL$Game$Team$neutral);
        return $2600;
    })), List$nil))));

    function Deserializer$monad$(_new$2) {
        var $2601 = _new$2(Deserializer$bind)(Deserializer$pure);
        return $2601;
    };
    ...
    function Word$deserializer$(_size$1) {
        var self = _size$1;
        if (self === 0n) {
            var $2603 = Deserializer$monad$((_m$bind$2 => _m$pure$3 => {
                var $2604 = _m$pure$3;
                return $2604;
            }))(Word$e);
            var $2602 = $2603;
            ...
            var $2605 = (self - 1n);
            var $2606 = Deserializer$choice$(List$cons$(Deserializer$monad$((_m$bind$3 => _m$pure$4 => {
                var $2607 = _m$bind$3;
                return $2607;
            }))(Deserializer$bits((Bits$e + '0')))((_$3 => {
                var $2608 = Deserializer$monad$((_m$bind$4 => _m$pure$5 => {
                    var $2609 = _m$bind$4;
                    return $2609;
                }))(Word$deserializer$($2605))((_pred$4 => {
                    var $2610 = Deserializer$monad$((_m$bind$5 => _m$pure$6 => {
                        var $2611 = _m$pure$6;
                        return $2611;
                    }))(Word$o$(_pred$4));
                    return $2610;
                ...
                var $2613 = Deserializer$monad$((_m$bind$4 => _m$pure$5 => {
                    var $2614 = _m$bind$4;
                    return $2614;
                }))(Word$deserializer$($2605))((_pred$4 => {
                    var $2615 = Deserializer$monad$((_m$bind$5 => _m$pure$6 => {
                        var $2616 = _m$pure$6;
                        return $2616;
                    }))(Word$i$(_pred$4));
                    return $2615;
    ...
    const U8$deserializer = Deserializer$monad$((_m$bind$1 => _m$pure$2 => {
        ...
        var $2618 = Deserializer$monad$((_m$bind$2 => _m$pure$3 => {
            var $2619 = _m$pure$3;
            return $2619;
        }))(U8$new$(_word$1));
        return $2618;
    ...
    const I32$deserializer = Deserializer$monad$((_m$bind$1 => _m$pure$2 => {
        ...
        var $2621 = Deserializer$monad$((_m$bind$2 => _m$pure$3 => {
            var $2622 = _m$pure$3;
            return $2622;
        }))(I32$new$(_word$1));
        return $2621;
    ...
    const Hexagonal$Axial$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits(Bits$e))((_$1 => {
        var $2623 = Deserializer$bind(I32$deserializer)((_i$2 => {
            var $2624 = Deserializer$bind(I32$deserializer)((_j$3 => {
                var $2625 = Deserializer$pure(Hexagonal$Axial$new$(_i$2, _j$3));
                return $2625;
            }));
            return $2624;
        }));
    ...
    const App$KL$Game$Phase$Draft$Event$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '0') + '0')))((_$1 => {
        var $2626 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$join_room);
        return $2626;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '0') + '1')))((_$1 => {
        var $2627 = Deserializer$bind(App$KL$Game$Team$deserializer)((_team$2 => {
            var $2628 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_team$(_team$2));
            return $2628;
        }));
        return $2627;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '1') + '0')))((_$1 => {
        var $2629 = Deserializer$bind(U8$deserializer)((_hero$2 => {
            var $2630 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_hero$(_hero$2));
            return $2630;
        }));
        return $2629;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '1') + '1')))((_$1 => {
        var $2631 = Deserializer$bind(Hexagonal$Axial$deserializer)((_coord$2 => {
            var $2632 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_init_pos$(_coord$2));
            return $2632;
        }));
        return $2631;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '1') + '0') + '0')))((_$1 => {
        var $2633 = Deserializer$bind(U8$deserializer)((_ready$2 => {
            var $2634 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_ready$(_ready$2));
            return $2634;
        }));
        return $2633;
    })), List$nil))))));
    const U16$deserializer = Deserializer$monad$((_m$bind$1 => _m$pure$2 => {
        ...
        var $2636 = Deserializer$monad$((_m$bind$2 => _m$pure$3 => {
            var $2637 = _m$pure$3;
            return $2637;
        }))(U16$new$(_word$1));
        return $2636;
    ...
    const App$KL$Game$Phase$Play$Event$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits(Bits$e))((_$1 => {
        var $2638 = Deserializer$bind(Char$deserializer)((_letter$2 => {
            var $2639 = Deserializer$bind(Hexagonal$Axial$deserializer)((_target$3 => {
                var $2640 = Deserializer$pure(App$KL$Game$Phase$Play$Event$cast$(_letter$2, _target$3));
                return $2640;
            }));
            return $2639;
        }));
    ...
    const App$KL$Game$Event$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '0')))((_$1 => {
        var $2641 = Deserializer$bind(App$KL$Game$Phase$Draft$Event$deserializer)((_event$2 => {
            var $2642 = Deserializer$pure(App$KL$Game$Event$draft$(_event$2));
            return $2642;
        }));
        return $2641;
    })), List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '1')))((_$1 => {
        var $2643 = Deserializer$bind(App$KL$Game$Phase$Play$Event$deserializer)((_event$2 => {
            var $2644 = Deserializer$pure(App$KL$Game$Event$play$(_event$2));
            return $2644;
        }));
        return $2643;
    })), List$nil)));
    const App$KL$Global$Event$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '0')))((_$1 => {
        var $2645 = Deserializer$pure(App$KL$Global$Event$void);
        return $2645;
    })), List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '1')))((_$1 => {
        var $2646 = Deserializer$bind(App$KL$Game$Event$deserializer)((_event$2 => {
            var $2647 = Deserializer$pure(App$KL$Global$Event$game$(_event$2));
            return $2647;
        }));
        return $2646;
    })), List$nil)));
    ...
    function Bits$hex$decode$(_x$1) {
        ...
        if (self.length === 0) {
            ...
            var $2650 = self.charCodeAt(0);
            var $2651 = self.slice(1);
            var self = ($2650 === 48);
            if (self) {
                var $2653 = ((((Bits$hex$decode$($2651) + '0') + '0') + '0') + '0');
                var $2652 = $2653;
            } else {
                var self = ($2650 === 49);
                if (self) {
                    var $2655 = ((((Bits$hex$decode$($2651) + '0') + '0') + '0') + '1');
                    var $2654 = $2655;
                } else {
                    var self = ($2650 === 50);
                    if (self) {
                        var $2657 = ((((Bits$hex$decode$($2651) + '0') + '0') + '1') + '0');
                        var $2656 = $2657;
                    } else {
                        var self = ($2650 === 51);
                        if (self) {
                            var $2659 = ((((Bits$hex$decode$($2651) + '0') + '0') + '1') + '1');
                            var $2658 = $2659;
                        } else {
                            var self = ($2650 === 52);
                            if (self) {
                                var $2661 = ((((Bits$hex$decode$($2651) + '0') + '1') + '0') + '0');
                                var $2660 = $2661;
                            } else {
                                var self = ($2650 === 53);
                                if (self) {
                                    var $2663 = ((((Bits$hex$decode$($2651) + '0') + '1') + '0') + '1');
                                    var $2662 = $2663;
                                } else {
                                    var self = ($2650 === 54);
                                    if (self) {
                                        var $2665 = ((((Bits$hex$decode$($2651) + '0') + '1') + '1') + '0');
                                        var $2664 = $2665;
                                    } else {
                                        var self = ($2650 === 55);
                                        if (self) {
                                            var $2667 = ((((Bits$hex$decode$($2651) + '0') + '1') + '1') + '1');
                                            var $2666 = $2667;
                                        } else {
                                            var self = ($2650 === 56);
                                            if (self) {
                                                var $2669 = ((((Bits$hex$decode$($2651) + '1') + '0') + '0') + '0');
                                                var $2668 = $2669;
                                            } else {
                                                var self = ($2650 === 57);
                                                if (self) {
                                                    var $2671 = ((((Bits$hex$decode$($2651) + '1') + '0') + '0') + '1');
                                                    var $2670 = $2671;
                                                } else {
                                                    var self = ($2650 === 97);
                                                    if (self) {
                                                        var $2673 = ((((Bits$hex$decode$($2651) + '1') + '0') + '1') + '0');
                                                        var $2672 = $2673;
                                                    } else {
                                                        var self = ($2650 === 98);
                                                        if (self) {
                                                            var $2675 = ((((Bits$hex$decode$($2651) + '1') + '0') + '1') + '1');
                                                            var $2674 = $2675;
                                                        } else {
                                                            var self = ($2650 === 99);
                                                            if (self) {
                                                                var $2677 = ((((Bits$hex$decode$($2651) + '1') + '1') + '0') + '0');
                                                                var $2676 = $2677;
                                                            } else {
                                                                var self = ($2650 === 100);
                                                                if (self) {
                                                                    var $2679 = ((((Bits$hex$decode$($2651) + '1') + '1') + '0') + '1');
                                                                    var $2678 = $2679;
                                                                } else {
                                                                    var self = ($2650 === 101);
                                                                    if (self) {
                                                                        var $2681 = ((((Bits$hex$decode$($2651) + '1') + '1') + '1') + '0');
                                                                        var $2680 = $2681;
                                                                    } else {
                                                                        var self = ($2650 === 102);
                                                                        if (self) {
                                                                            var $2683 = ((((Bits$hex$decode$($2651) + '1') + '1') + '1') + '1');
                                                                            var $2682 = $2683;
                                                                        } else {
                                                                            var self = ($2650 === 65);
                                                                            if (self) {
                                                                                var $2685 = ((((Bits$hex$decode$($2651) + '1') + '0') + '1') + '0');
                                                                                var $2684 = $2685;
                                                                            } else {
                                                                                var self = ($2650 === 66);
                                                                                if (self) {
                                                                                    var $2687 = ((((Bits$hex$decode$($2651) + '1') + '0') + '1') + '1');
                                                                                    var $2686 = $2687;
                                                                                } else {
                                                                                    var self = ($2650 === 67);
                                                                                    if (self) {
                                                                                        var $2689 = ((((Bits$hex$decode$($2651) + '1') + '1') + '0') + '0');
                                                                                        var $2688 = $2689;
                                                                                    } else {
                                                                                        var self = ($2650 === 68);
                                                                                        if (self) {
                                                                                            var $2691 = ((((Bits$hex$decode$($2651) + '1') + '1') + '0') + '1');
                                                                                            var $2690 = $2691;
                                                                                        } else {
                                                                                            var self = ($2650 === 69);
                                                                                            if (self) {
                                                                                                var $2693 = ((((Bits$hex$decode$($2651) + '1') + '1') + '1') + '0');
                                                                                                var $2692 = $2693;
                                                                                            } else {
                                                                                                var self = ($2650 === 70);
                                                                                                if (self) {
                                                                                                    var $2695 = ((((Bits$hex$decode$($2651) + '1') + '1') + '1') + '1');
                                                                                                    var $2694 = $2695;
                                                                                                } else {
                                                                                                    var $2696 = Bits$e;
                                                                                                    var $2694 = $2696;
    ...
    function App$KL$Global$Event$deserialize_post$(_hex$1) {
        var $2697 = Deserializer$run$(App$KL$Global$Event$deserializer, Bits$hex$decode$(String$drop$(2n, _hex$1)));
        return $2697;
    };
    ...
    const App$KL$Game$start = (() => {
        ...
        var $2698 = App$KL$Game$new$(_tick$4, _phase$1, _players$2, _board$3, _casts$5);
        return $2698;
    })();
    ...
    function App$KL$Game$Phase$Draft$has_hero$(_hero_id$1, _player$2) {
        ...
        switch (self._) {
            case 'Maybe.some':
                var $2705 = self.value;
                var $2706 = ((Number($2705) & 0xFF) === _hero_id$1);
                var $2700 = $2706;
                break;
            case 'Maybe.none':
                var $2707 = Bool$false;
    ...
    function App$KL$Game$Phase$Draft$has_coord$(_coord$1, _player$2) {
        ...
        switch (self._) {
            case 'Maybe.some':
                var $2713 = self.value;
                var $2714 = Hexagonal$Axial$eql$($2713, _coord$1);
                var $2708 = $2714;
                break;
            case 'Maybe.none':
                var $2715 = Bool$false;
    ...
    function App$KL$Game$Phase$Draft$post$(_time$1, _room$2, _addr$3, _event$4, _game$5) {
        ...
        switch (self._) {
            case 'App.KL.Game.Phase.Draft.Event.set_team':
                var $2717 = self.team;
                var $2718 = ((console.log("- set_team"), (_$7 => {
                    var self = _game$5;
                    switch (self._) {
                        case 'App.KL.Game.new':
                            var $2720 = self.tick;
                            ...
                            var $2722 = self.board;
                            var $2723 = self.casts;
                            var $2724 = App$KL$Game$new$($2720, $2721, Map$set$(_addr$3, App$KL$Game$Player$new$(Maybe$none, Maybe$none, $2717, Bool$false), (() => {
                                var self = _game$5;
                                switch (self._) {
                                    case 'App.KL.Game.new':
                                        var $2725 = self.players;
                                        var $2726 = $2725;
                                        return $2726;
                                };
                            })()), $2722, $2723);
            ...
            case 'App.KL.Game.Phase.Draft.Event.set_hero':
                var $2727 = self.hero;
                var $2728 = ((console.log("- set_hero"), (_$7 => {
                    var $2729 = Maybe$default$((() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2731 = self.players;
                                var $2732 = $2731;
                                var _players$8 = $2732;
                                break;
                        };
                        var $2730 = Maybe$monad$((_m$bind$9 => _m$pure$10 => {
                            var $2733 = _m$bind$9;
                            return $2733;
                        }))(Map$get$(_addr$3, _players$8))((_player$9 => {
                            var _player_list$10 = Map$to_list$(_players$8);
                            var _is_picked$11 = List$fold$(List$map$(App$KL$Game$Phase$Draft$has_hero($2727), _player_list$10), Bool$false, Bool$or);
                            var self = _game$5;
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    var $2735 = self.tick;
                                    ...
                                    var $2737 = self.board;
                                    var $2738 = self.casts;
                                    var $2739 = App$KL$Game$new$($2735, $2736, Map$set$(_addr$3, (() => {
                                        var self = _player$9;
                                        switch (self._) {
                                            case 'App.KL.Game.Player.new':
                                                var $2740 = self.init_pos;
                                                var $2741 = self.team;
                                                var $2742 = self.ready;
                                                var $2743 = App$KL$Game$Player$new$(Maybe$some$((BigInt($2727))), $2740, $2741, $2742);
                                                return $2743;
                                        };
                                    })(), _players$8), $2737, $2738);
                                    var _game$12 = $2739;
                                    break;
                            };
            ...
            case 'App.KL.Game.Phase.Draft.Event.set_init_pos':
                var $2746 = self.coord;
                var $2747 = ((console.log("- set_init_pos"), (_$7 => {
                    var $2748 = Maybe$default$((() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                        ...
                        var $2749 = Maybe$monad$((_m$bind$9 => _m$pure$10 => {
                            var $2752 = _m$bind$9;
                            return $2752;
                        }))(Map$get$(_addr$3, _players$8))((_player$9 => {
                            var _player_list$10 = Map$to_list$(_players$8);
                            var _is_occupied$11 = List$fold$(List$map$(App$KL$Game$Phase$Draft$has_coord($2746), _player_list$10), Bool$false, Bool$or);
                            var self = _game$5;
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    var $2754 = self.tick;
                                    ...
                                    var $2756 = self.board;
                                    var $2757 = self.casts;
                                    var $2758 = App$KL$Game$new$($2754, $2755, Map$set$(_addr$3, (() => {
                                        var self = _player$9;
                                        switch (self._) {
                                            case 'App.KL.Game.Player.new':
                                                var $2759 = self.hero_id;
                                                var $2760 = self.team;
                                                var $2761 = self.ready;
                                                var $2762 = App$KL$Game$Player$new$($2759, Maybe$some$($2746), $2760, $2761);
                                                return $2762;
                                        };
                                    })(), _players$8), $2756, $2757);
                                    var _game$12 = $2758;
                                    break;
                            };
            ...
            case 'App.KL.Game.Phase.Draft.Event.set_ready':
                var $2765 = self.ready;
                var $2766 = ((console.log("- set_ready"), (_$7 => {
                    var $2767 = Maybe$default$((() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2769 = self.players;
                                var $2770 = $2769;
                                var _players$8 = $2770;
                                break;
                        };
                        var $2768 = Maybe$monad$((_m$bind$9 => _m$pure$10 => {
                            var $2771 = _m$bind$9;
                            return $2771;
                        }))(Map$get$(_addr$3, _players$8))((_player$9 => {
                            var _ready$10 = ($2765 === 1);
                            var self = _game$5;
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    var $2773 = self.tick;
                                    ...
                                    var $2775 = self.board;
                                    var $2776 = self.casts;
                                    var $2777 = App$KL$Game$new$($2773, $2774, Map$set$(_addr$3, (() => {
                                        var self = _player$9;
                                        switch (self._) {
                                            case 'App.KL.Game.Player.new':
                                                var $2778 = self.hero_id;
                                                var $2779 = self.init_pos;
                                                var $2780 = self.team;
                                                var $2781 = App$KL$Game$Player$new$($2778, $2779, $2780, _ready$10);
                                                return $2781;
                                        };
                                    })(), _players$8), $2775, $2776);
                                    var _game$11 = $2777;
                                    break;
                            };
                            var $2772 = Maybe$some$(_game$11);
                            return $2772;
                        }));
                        return $2768;
                    })(), _game$5);
                ...
                break;
            case 'App.KL.Game.Phase.Draft.Event.join_room':
                var $2782 = ((console.log("- join_room"), (_$6 => {
                    var _player$7 = Map$get$(_addr$3, (() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2784 = self.players;
                                var $2785 = $2784;
                                return $2785;
                        };
                    })());
                        ...
                        case 'Maybe.some':
                            ...
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    ...
                                    var $2790 = self.board;
                                    var $2791 = self.casts;
                                    var $2792 = App$KL$Game$new$($2788, $2789, Map$set$(_addr$3, $2786, (() => {
                                        var self = _game$5;
                                        switch (self._) {
                                            case 'App.KL.Game.new':
                        ...
                        case 'Maybe.none':
                            ...
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    ...
                                    var $2798 = self.board;
                                    var $2799 = self.casts;
                                    var $2800 = App$KL$Game$new$($2796, $2797, Map$set$(_addr$3, App$KL$Game$Player$new$(Maybe$none, Maybe$none, App$KL$Game$Team$neutral, Bool$false), (() => {
                                        var self = _game$5;
                                        switch (self._) {
                                            case 'App.KL.Game.new':
                                                var $2801 = self.players;
                                                var $2802 = $2801;
                                                return $2802;
                                        };
                                    })()), $2798, $2799);
    ...
    function App$KL$Game$Cast$push$(_player$1, _target$2, _letter$3, _casts$4) {
        var $2804 = List$cons$(App$KL$Game$Cast$new$(_player$1, _target$2, _letter$3), _casts$4);
        return $2804;
    };
    ...
    function App$KL$Game$Phase$Play$post$(_time$1, _room$2, _addr$3, _event$4, _game$5) {
        ...
        switch (self._) {
            case 'App.KL.Game.Phase.Play.Event.cast':
                var $2806 = self.letter;
                var $2807 = self.target;
                var $2808 = ((console.log(("got cast " + (_addr$3 + (" " + Char$to_string$($2806))))), (_$8 => {
                    var self = _game$5;
                    switch (self._) {
                        case 'App.KL.Game.new':
                            var $2810 = self.tick;
                            var $2811 = self.phase;
                            var $2812 = self.players;
                            var $2813 = self.board;
                            var $2814 = App$KL$Game$new$($2810, $2811, $2812, $2813, App$KL$Game$Cast$push$(_addr$3, $2807, $2806, (() => {
                                var self = _game$5;
                                switch (self._) {
                                    case 'App.KL.Game.new':
                                        var $2815 = self.casts;
            ...
            case 'App.KL.Game.new':
                ...
                switch (self._) {
                    case 'App.KL.Game.Event.draft':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Phase.draft':
                                var $2822 = App$KL$Game$Phase$Draft$post$(_time$1, _room$2, _addr$3, $2820, _game$5);
                                var $2821 = $2822;
                                break;
                            case 'App.KL.Game.Phase.play':
                                var $2823 = _game$5;
                    ...
                    case 'App.KL.Game.Event.play':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Phase.draft':
                                ...
                                break;
                            case 'App.KL.Game.Phase.play':
                                var $2827 = App$KL$Game$Phase$Play$post$(_time$1, _room$2, _addr$3, $2824, _game$5);
                                var $2825 = $2827;
                                break;
                        };
                        var $2819 = $2825;
            ...
            case 'Maybe.some':
                ...
                switch (self._) {
                    case 'App.KL.Global.Event.game':
                        ...
                        switch (self._) {
                            case 'App.KL.Global.State.new':
                                var $2835 = App$KL$Global$State$new$(Maybe$some$(App$KL$Game$post$(_time$1, _room$2, _addr$3, $2831, _game$8)));
                                var $2832 = $2835;
                                break;
                        };
                        var $2830 = $2832;
    ...
    const App$KL = (() => {
        ...
        var $2838 = App$new$(App$KL$init, App$KL$draw(_img$1), App$KL$when, App$KL$Global$tick, App$KL$Global$post);
        return $2838;
    })();
    return {
