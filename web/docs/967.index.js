...
module.exports = (function() {
    ...
    function App$KL$Game$Phase$Play$draw$tile$terrain$indicator$(_tile_coord$1, _mouse_coord$2, _casts$3) {
    ...
    function App$KL$Game$Phase$Play$draw$letter$(_tile_coord$1, _casts$2, _img$3) {
        var self = _casts$2;
        switch (self._) {
            case 'Maybe.some':
                var $1983 = self.value;
                    ...
                    case 'App.KL.Game.Casts.new':
                        ...
                        switch (self._) {
                            case 'Maybe.some':
                                ...
                                var self = App$KL$Game$Phase$Play$draw$centralize_letter$(_screen_coord$8);
                                switch (self._) {
                                    case 'Pair.new':
                                        var $1989 = self.fst;
                                        var $1990 = self.snd;
    ...
    function App$KL$Game$Phase$Play$draw$tile$terrain$(_terrain$1, _casts$2, _tile_coord$3, _mouse_coord$4, _img$5) {
        var _indicator$6 = App$KL$Game$Phase$Play$draw$tile$terrain$indicator$(_tile_coord$3, _mouse_coord$4, _casts$2);
        ...
        switch (self._) {
            case 'Pair.new':
                ...
                var _tile_drawing$12 = App$KL$Game$Phase$Play$draw$letter$(_tile_coord$3, _casts$2, _tile_drawing$11);
            ...
            case 'Maybe.some':
                ...
                switch (self._) {
                    case 'Pair.new':
                        ...
                        var _drawing$8 = _drawing$8($2003);
                        var _aux$9 = I32$to_u32$(App$KL$Constants$hexagon_radius);
                        var _cy$10 = (($2006 - ((_aux$9 * 2) >>> 0)) >>> 0);
                        var _cx$11 = (($2005 - _aux$9) >>> 0);
    ...
    function App$KL$Game$Phase$Play$draw$board$(_map$1, _casts$2, _mouse$3, _img$4) {
                        ...
                        var _img$11 = App$KL$Game$Phase$Play$draw$tile$terrain$((() => {
                            ...
                            switch (self._) {
                                case 'App.KL.Game.Tile.new':
                                    var $2020 = self.terrain;
                                    var $2021 = $2020;
                                    return $2021;
                            };
                        })(), _casts$2, $2017, _mouse_coord$6, _img$8);
                        var _img$12 = App$KL$Game$Phase$Play$draw$tile$creature$((() => {
                            var self = $2018;
                            switch (self._) {
                                case 'App.KL.Game.Tile.new':
                                    var $2022 = self.creature;
                                    var $2023 = $2022;
                                    return $2023;
                            };
                        })(), $2017, _img$11);
    ...
    function App$KL$Game$Phase$Play$draw$cursor$(_mouse$1, _img$2) {
        ...
        switch (self._) {
            case 'Pair.new':
                var $2025 = self.fst;
                var $2026 = self.snd;
                var $2027 = VoxBox$Draw$image$($2025, $2026, 0, App$Kaelin$Assets$tile$mouse_ui, _img$2);
                var $2024 = $2027;
                break;
        };
        return $2024;
    ...
    function App$KL$Game$Phase$Play$draw$(_img$1, _local$2, _game$3) {
        var $2037 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("width", "100vw"), List$cons$(Pair$new$("height", "100vh"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("flex-direction", "column"), List$cons$(Pair$new$("justify-content", "center"), List$cons$(Pair$new$("align-items", "center"), List$cons$(Pair$new$("position", "relative"), List$nil)))))))), List$cons$(DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$(DOM$text$(("Time: " + ((() => {
            var self = _game$3;
            switch (self._) {
                case 'App.KL.Game.new':
                    var $2038 = self.tick;
            ...
            var $2040 = DOM$vbox$(Map$from_list$(List$cons$(Pair$new$("id", "game_screen"), List$cons$(Pair$new$("width", _width$4), List$cons$(Pair$new$("height", _height$5), List$cons$(Pair$new$("scale", "2"), List$nil))))), Map$from_list$(List$nil), App$KL$Game$Phase$Play$draw$canvas$(_img$1, _local$2, _game$3));
            return $2040;
        })(), List$nil)), List$nil)));
        return $2037;
    };
    ...
    function App$KL$Game$draw$(_img$1, _local$2, _global$3) {
        var $2041 = DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$((() => {
            var self = _global$3;
            switch (self._) {
                case 'App.KL.Global.State.new':
                    var $2043 = self.game;
            ...
            switch (self._) {
                case 'Maybe.some':
                    var $2045 = self.value;
                    var $2046 = DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$((() => {
                        var self = $2045;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2048 = self.phase;
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Phase.draft':
                                var $2050 = App$KL$Game$Phase$Draft$draw$(_local$2, _global$3);
                                var $2047 = $2050;
                                break;
                            case 'App.KL.Game.Phase.play':
                                var $2051 = App$KL$Game$Phase$Play$draw$(_img$1, _local$2, $2045);
                                var $2047 = $2051;
                                break;
                        };
                        return $2047;
                    ...
                    break;
                case 'Maybe.none':
                    var $2052 = DOM$node$("div", Map$from_list$(List$nil), Map$new, List$cons$(DOM$text$("Not ingame."), List$nil));
                    var $2042 = $2052;
                    break;
            };
            return $2042;
    ...
    function App$KL$draw$(_img$1, _state$2) {
        ...
        switch (self._) {
            case 'App.Store.new':
                var $2054 = self.local;
                var $2055 = self.global;
                var self = $2054;
                switch (self._) {
                    case 'App.KL.State.Local.lobby':
                        var $2057 = self.state;
                        var $2058 = App$KL$Lobby$draw$($2057, $2055);
                        var $2056 = $2058;
                        break;
                    case 'App.KL.State.Local.game':
                        var $2059 = self.state;
                        var $2060 = App$KL$Game$draw$(_img$1, $2059, $2055);
                        var $2056 = $2060;
                        break;
                };
                var $2053 = $2056;
    ...
    function String$map$(_f$1, _as$2) {
        ...
        if (self.length === 0) {
            ...
            var $2064 = self.charCodeAt(0);
            var $2065 = self.slice(1);
            var $2066 = String$cons$(_f$1($2064), String$map$(_f$1, $2065));
            var $2062 = $2066;
        };
        return $2062;
    };
    ...
    function String$to_lower$(_str$1) {
        var $2070 = String$map$(Char$to_lower, _str$1);
        return $2070;
    };
    ...
    function IO$bind$(_a$3, _f$4) {
        ...
        switch (self._) {
            ...
            case 'IO.ask':
                ...
                var $2076 = self.param;
                var $2077 = self.then;
                var $2078 = IO$ask$($2075, $2076, (_x$8 => {
                    var $2079 = IO$bind$($2077(_x$8), _f$4);
                    return $2079;
                }));
                var $2072 = $2078;
                break;
    ...
    function IO$monad$(_new$2) {
        var $2081 = _new$2(IO$bind)(IO$end);
        return $2081;
    };
    const IO$monad = x0 => IO$monad$(x0);

    function App$set_local$(_value$2) {
        var $2082 = IO$monad$((_m$bind$3 => _m$pure$4 => {
            var $2083 = _m$pure$4;
            return $2083;
        }))(Maybe$some$(_value$2));
        return $2082;
    ...
    const IO$get_time = IO$ask$("get_time", "", (_time$1 => {
        var $2085 = IO$end$((BigInt(_time$1)));
        return $2085;
    }));
    ...
    function Nat$random$(_seed$1) {
        ...
        var $2086 = (((_seed$1 * _m$2) + _i$3) % _q$4);
        return $2086;
    };
    const Nat$random = x0 => Nat$random$(x0);

    function IO$random$(_a$1) {
        var $2087 = IO$monad$((_m$bind$2 => _m$pure$3 => {
            var $2088 = _m$bind$2;
            return $2088;
        }))(IO$get_time)((_seed$2 => {
            var _seed$3 = Nat$random$(_seed$2);
            var $2089 = IO$monad$((_m$bind$4 => _m$pure$5 => {
                var $2090 = _m$pure$5;
                return $2090;
            }))((_seed$3 % _a$1));
            return $2089;
            ...
            var R = (() => {
                ...
                if (self === 0n) {
                    ...
                    if (self.length === 0) {
                        ...
                        var $2095 = self.charCodeAt(0);
                        var $2096 = self.slice(1);
                        var $2097 = String$drop$($2092, $2096);
                        var $2093 = $2097;
                    };
                    return $2093;
                };
        ...
        while (true) {
            ...
            var R = (() => {
                ...
                if (self.length === 0) {
                    ...
                    var $2101 = String$length$go$($2100, Nat$succ$(_n$2));
                    return $2101;
                };
            })();
            if (R.ctr === 'TCO') arg = R.arg;
    ...
    function String$length$(_xs$1) {
        var $2102 = String$length$go$(_xs$1, 0n);
        return $2102;
    };
    const String$length = x0 => String$length$(x0);

    function IO$do$(_call$1, _param$2) {
        var $2103 = IO$ask$(_call$1, _param$2, (_answer$3 => {
            var $2104 = IO$end$(Unit$new);
            return $2104;
        }));
        return $2103;
    };
    ...
    function App$do$(_call$2, _param$3) {
        var $2105 = IO$monad$((_m$bind$4 => _m$pure$5 => {
            var $2106 = _m$bind$4;
            return $2106;
    ...
    function String$take$(_n$1, _xs$2) {
        ...
        if (self.length === 0) {
            ...
            var $2114 = self.charCodeAt(0);
            var $2115 = self.slice(1);
            var self = _n$1;
            if (self === 0n) {
                var $2117 = String$nil;
                var $2116 = $2117;
                ...
                var $2118 = (self - 1n);
                var $2119 = String$cons$($2114, String$take$($2118, $2115));
                var $2116 = $2119;
            };
            var $2112 = $2116;
        };
    ...
    function String$pad_right$(_size$1, _chr$2, _str$3) {
        ...
        if (self === 0n) {
            ...
            var self = _str$3;
            if (self.length === 0) {
                var $2124 = String$cons$(_chr$2, String$pad_right$($2122, _chr$2, ""));
                var $2123 = $2124;
            } else {
                var $2125 = self.charCodeAt(0);
                var $2126 = self.slice(1);
                var $2127 = String$cons$($2125, String$pad_right$($2122, _chr$2, $2126));
                var $2123 = $2127;
            };
            var $2120 = $2123;
        };
    ...
    function String$pad_right_exact$(_size$1, _chr$2, _str$3) {
        var $2128 = String$take$(_size$1, String$pad_right$(_size$1, _chr$2, _str$3));
        return $2128;
    };
            ...
            case 'o':
                ...
                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            ...
                            case 'o':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2137 = ("0" + Bits$hex$encode$($2136));
                                        var $2135 = $2137;
                                        break;
                                    case 'i':
                                        var $2138 = self.slice(0, -1);
                                        var $2139 = ("8" + Bits$hex$encode$($2138));
                                        var $2135 = $2139;
                                        break;
                                    case 'e':
                                        var $2140 = "0";
                            ...
                            case 'i':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2144 = ("4" + Bits$hex$encode$($2143));
                                        var $2142 = $2144;
                                        break;
                                    case 'i':
                                        var $2145 = self.slice(0, -1);
                                        var $2146 = ("c" + Bits$hex$encode$($2145));
                                        var $2142 = $2146;
                                        break;
                                    case 'e':
                                        var $2147 = "4";
                    ...
                    case 'i':
                        ...
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'o':
                                var $2151 = self.slice(0, -1);
                                var self = $2151;
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        var $2153 = self.slice(0, -1);
                                        var $2154 = ("2" + Bits$hex$encode$($2153));
                                        var $2152 = $2154;
                                        break;
                                    case 'i':
                                        var $2155 = self.slice(0, -1);
                                        var $2156 = ("a" + Bits$hex$encode$($2155));
                                        var $2152 = $2156;
                                        break;
                                    case 'e':
                                        var $2157 = "2";
                                ...
                                break;
                            case 'i':
                                var $2158 = self.slice(0, -1);
                                var self = $2158;
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        var $2160 = self.slice(0, -1);
                                        var $2161 = ("6" + Bits$hex$encode$($2160));
                                        var $2159 = $2161;
                                        break;
                                    case 'i':
                                        var $2162 = self.slice(0, -1);
                                        var $2163 = ("e" + Bits$hex$encode$($2162));
                                        var $2159 = $2163;
                                        break;
                                    case 'e':
                                        var $2164 = "6";
            ...
            case 'i':
                ...
                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            ...
                            case 'o':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2174 = ("1" + Bits$hex$encode$($2173));
                                        var $2172 = $2174;
                                        break;
                                    case 'i':
                                        var $2175 = self.slice(0, -1);
                                        var $2176 = ("9" + Bits$hex$encode$($2175));
                                        var $2172 = $2176;
                                        break;
                                    case 'e':
                                        var $2177 = "1";
                            ...
                            case 'i':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        ...
                                        var $2181 = ("5" + Bits$hex$encode$($2180));
                                        var $2179 = $2181;
                                        break;
                                    case 'i':
                                        var $2182 = self.slice(0, -1);
                                        var $2183 = ("d" + Bits$hex$encode$($2182));
                                        var $2179 = $2183;
                                        break;
                                    case 'e':
                                        var $2184 = "5";
                    ...
                    case 'i':
                        ...
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'o':
                                var $2188 = self.slice(0, -1);
                                var self = $2188;
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        var $2190 = self.slice(0, -1);
                                        var $2191 = ("3" + Bits$hex$encode$($2190));
                                        var $2189 = $2191;
                                        break;
                                    case 'i':
                                        var $2192 = self.slice(0, -1);
                                        var $2193 = ("b" + Bits$hex$encode$($2192));
                                        var $2189 = $2193;
                                        break;
                                    case 'e':
                                        var $2194 = "3";
                            ...
                            case 'i':
                                ...
                                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                                    case 'o':
                                        var $2197 = self.slice(0, -1);
                                        var $2198 = ("7" + Bits$hex$encode$($2197));
                                        var $2196 = $2198;
                                        break;
                                    case 'i':
                                        var $2199 = self.slice(0, -1);
                                        var $2200 = ("f" + Bits$hex$encode$($2199));
                                        var $2196 = $2200;
                                        break;
                                    case 'e':
                                        var $2201 = "7";
    ...
    function Serializer$run$(_serializer$2, _x$3) {
        var $2205 = _serializer$2(_x$3)(Bits$e);
        return $2205;
    };
    ...
    function Word$serializer$(_w$2, _bs$3) {
        ...
        switch (self._) {
            case 'Word.o':
                var $2211 = self.pred;
                var $2212 = (Word$serializer$($2211, _bs$3) + '0');
                var $2210 = $2212;
                break;
            case 'Word.i':
                var $2213 = self.pred;
                var $2214 = (Word$serializer$($2213, _bs$3) + '1');
                var $2210 = $2214;
                break;
            case 'Word.e':
                var $2215 = _bs$3;
    ...
    function U8$serializer$(_x$1, _bs$2) {
        ...
        switch ('u8') {
            case 'u8':
                var $2217 = u8_to_word(self);
                var $2218 = Word$serializer$($2217, _bs$2);
                var $2216 = $2218;
                break;
        };
        return $2216;
    ...
    function I32$serializer$(_x$1, _bs$2) {
        ...
        switch ('i32') {
            case 'i32':
                var $2220 = i32_to_word(self);
                var $2221 = Word$serializer$($2220, _bs$2);
                var $2219 = $2221;
                break;
        };
        return $2219;
    ...
    function Hexagonal$Axial$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'Hexagonal.Axial.new':
                var $2223 = self.i;
                var $2224 = self.j;
                var $2225 = I32$serializer$($2223, I32$serializer$($2224, _bs$2));
                var $2222 = $2225;
                break;
        };
        return $2222;
    ...
    function App$KL$Game$Phase$Draft$Event$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.Phase.Draft.Event.set_team':
                var $2227 = self.team;
                var $2228 = (((App$KL$Game$Team$serializer$($2227, _bs$2) + '0') + '0') + '1');
                var $2226 = $2228;
                break;
            case 'App.KL.Game.Phase.Draft.Event.set_hero':
                var $2229 = self.hero;
                var $2230 = (((U8$serializer$($2229, _bs$2) + '0') + '1') + '0');
                var $2226 = $2230;
                break;
            case 'App.KL.Game.Phase.Draft.Event.set_init_pos':
                var $2231 = self.coord;
                var $2232 = (((Hexagonal$Axial$serializer$($2231, _bs$2) + '0') + '1') + '1');
                var $2226 = $2232;
                break;
            case 'App.KL.Game.Phase.Draft.Event.set_ready':
                var $2233 = self.ready;
                var $2234 = (((U8$serializer$($2233, _bs$2) + '1') + '0') + '0');
                var $2226 = $2234;
                break;
            case 'App.KL.Game.Phase.Draft.Event.join_room':
                var $2235 = (((_bs$2 + '0') + '0') + '0');
                var $2226 = $2235;
                break;
        };
        return $2226;
    ...
    function App$KL$Game$Event$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.Event.draft':
                var $2238 = self.event;
                var $2239 = (App$KL$Game$Phase$Draft$Event$serializer$($2238, _bs$2) + '0');
                var $2237 = $2239;
                break;
            case 'App.KL.Game.Event.play':
                var $2240 = self.event;
                var $2241 = (App$KL$Game$Phase$Play$Event$serializer$($2240, _bs$2) + '1');
                var $2237 = $2241;
                break;
        };
        return $2237;
    ...
    function App$KL$Global$Event$serializer$(_x$1, _bs$2) {
        ...
        switch (self._) {
            case 'App.KL.Global.Event.game':
                var $2243 = self.event;
                var $2244 = (App$KL$Game$Event$serializer$($2243, _bs$2) + '1');
                var $2242 = $2244;
                break;
    ...
    function App$KL$Global$Event$serialize_post$(_ev$1) {
        var $2246 = ("0x" + String$pad_right_exact$(64n, 48, Bits$hex$encode$(Serializer$run$(App$KL$Global$Event$serializer, _ev$1))));
        return $2246;
    };
                    ...
                    if (self) {
                        var $2264 = IO$monad$((_m$bind$7 => _m$pure$8 => {
                            ...
                            var $2268 = IO$monad$((_m$bind$8 => _m$pure$9 => {
                                ...
                                var $2272 = App$set_local$(App$KL$State$Local$game$(App$KL$Game$State$Local$new$((() => {
                                    var self = _local$1;
                                    switch (self._) {
                                        case 'App.KL.Lobby.State.Local.new':
                                            var $2273 = self.user;
    ...
    function Char$to_string$(_chr$1) {
        var $2348 = String$cons$(_chr$1, String$nil);
        return $2348;
    };
    ...
    function Hexagonal$Axial$BBL$from_list$(_list$2) {
        var $2350 = BBL$from_list$(Hexagonal$Axial$cmp, _list$2);
        return $2350;
    };
    ...
    function Hexagonal$Axial$BBL$insert$(_key$2, _val$3, _map$4) {
        var $2351 = BBL$insert$(Hexagonal$Axial$cmp, _key$2, _val$3, _map$4);
        return $2351;
    };
    const Hexagonal$Axial$BBL$insert = x0 => x1 => x2 => Hexagonal$Axial$BBL$insert$(x0, x1, x2);

    function App$KL$Game$Phase$Play$when$(_local$1, _global$2, _event$3) {
        var self = _event$3;
        switch (self._) {
            case 'App.Event.key_down':
                var $2353 = self.code;
                var $2354 = ((console.log(("Key down " + Char$to_string$($2353))), (_$6 => {
                    var $2355 = ((console.log("Setting casts."), (_$7 => {
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Casts.new':
                                var $2361 = self.picks;
                                var $2362 = App$KL$Game$Casts$new$(Maybe$some$(Hexagonal$Axial$BBL$from_list$(List$cons$(Pair$new$(_coord$8, App$KL$Game$Indicator$blue), List$nil))), $2361);
                                var _casts$10 = $2362;
                                break;
                        };
                        var $2356 = App$set_local$(App$KL$State$Local$game$((() => {
                            var self = _local$1;
                            switch (self._) {
                                case 'App.KL.Game.State.Local.new':
                                    var $2363 = self.user;
                                    var $2364 = self.room;
                                    var $2365 = self.mouse;
                                    var $2366 = App$KL$Game$State$Local$new$($2363, $2364, Maybe$some$(_casts$10), $2365);
                                    return $2366;
                            };
                        })()));
                        return $2356;
            ...
            case 'App.Event.key_up':
                ...
                var $2368 = ((console.log(("Key up " + Char$to_string$($2367))), (_$6 => {
                    ...
                    switch (self._) {
                        case 'App.KL.Game.Casts.new':
                            var $2374 = self.areas;
                            var $2375 = App$KL$Game$Casts$new$($2374, Hexagonal$Axial$BBL$insert$(_coord$7, Char$to_string$($2367), (() => {
                                var self = _casts$8;
                                switch (self._) {
                                    case 'App.KL.Game.Casts.new':
                                        var $2376 = self.picks;
                    ...
                    switch (self._) {
                        case 'App.KL.Game.Casts.new':
                            var $2378 = self.picks;
                            var $2379 = App$KL$Game$Casts$new$(Maybe$none, $2378);
                            var _casts$10 = $2379;
                            break;
                    };
                    var $2369 = App$set_local$(App$KL$State$Local$game$((() => {
                        ...
                        switch (self._) {
                            case 'App.KL.Game.State.Local.new':
                                ...
                                var $2381 = self.room;
                                var $2382 = self.mouse;
                                var $2383 = App$KL$Game$State$Local$new$($2380, $2381, Maybe$some$(_casts$10), $2382);
                                return $2383;
                        };
                    })()));
                    return $2369;
            ...
            case 'App.Event.mouse_move':
                var $2384 = self.id;
                var $2385 = self.mouse_pos;
                var self = ("game_screen" === $2384);
                if (self) {
                    var self = $2385;
                    switch (self._) {
                        case 'Pair.new':
                            var $2388 = self.fst;
                            var $2389 = self.snd;
                            var $2390 = App$set_local$(App$KL$State$Local$game$((() => {
                                var self = _local$1;
                                switch (self._) {
                                    case 'App.KL.Game.State.Local.new':
                                        var $2391 = self.user;
                                        var $2392 = self.room;
                                        var $2393 = self.casts;
                                        var $2394 = App$KL$Game$State$Local$new$($2391, $2392, $2393, Pair$new$((($2388 / 2) >>> 0), (($2389 / 2) >>> 0)));
                                        return $2394;
                                };
                            })()));
                            var $2387 = $2390;
                    ...
                    case 'Maybe.some':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.new':
                                ...
                                switch (self._) {
                                    case 'App.KL.Game.Phase.draft':
                                        var $2404 = App$KL$Game$Phase$Draft$when$(_local$1, $2400, _event$3);
                                        var $2403 = $2404;
                                        break;
                                    case 'App.KL.Game.Phase.play':
                                        var $2405 = App$KL$Game$Phase$Play$when$(_local$1, $2400, _event$3);
                                        var $2403 = $2405;
                                        break;
                                };
                                var $2401 = $2403;
    ...
    function App$KL$when$(_event$1, _state$2) {
        ...
        switch (self._) {
            case 'App.Store.new':
                var $2408 = self.local;
                var $2409 = self.global;
                var self = $2408;
                switch (self._) {
                    case 'App.KL.State.Local.lobby':
                        var $2411 = self.state;
                        var $2412 = App$KL$Lobby$when$($2411, $2409, _event$1);
                        var $2410 = $2412;
                        break;
                    case 'App.KL.State.Local.game':
                        var $2413 = self.state;
                        var $2414 = App$KL$Game$when$($2413, $2409, _event$1);
                        var $2410 = $2414;
                        break;
                };
                var $2407 = $2410;
    ...
    function App$KL$Game$new$(_phase$1, _players$2, _board$3, _tick$4) {
        var $2415 = ({
            _: 'App.KL.Game.new',
            'phase': _phase$1,
            'players': _players$2,
    ...
    function Hexagonal$Axial$to_cubic$(_coord$1) {
        ...
        switch (self._) {
            case 'Hexagonal.Axial.new':
                ...
                var _z$5 = $2421;
                var _y$6 = ((((-_x$4)) - _z$5) >> 0);
                var $2422 = Hexagonal$Cubic$new$(_x$4, _y$6, _z$5);
                var $2419 = $2422;
                break;
        };
        return $2419;
    ...
    function Hexagonal$Axial$inside$(_coord$1, _region_size$2) {
        ...
        switch (self._) {
            case 'Hexagonal.Cubic.new':
                ...
                var $2425 = self.y;
                var $2426 = self.z;
                var _x$7 = I32$abs$($2424);
                var _y$8 = I32$abs$($2425);
                var _z$9 = I32$abs$($2426);
                var _greater$10 = I32$max$(_x$7, I32$max$(_y$8, _z$9));
                var $2427 = (_greater$10 <= _region_size$2);
                var $2423 = $2427;
                break;
        };
        return $2423;
    ...
    function App$KL$Game$Board$get$(_coord$1, _board$2) {
        var $2428 = Hexagonal$Axial$BBL$get$(_coord$1, _board$2);
        return $2428;
    };
    ...
    function App$KL$Game$Board$set$(_coord$1, _tile$2, _board$3) {
        var $2430 = Hexagonal$Axial$BBL$insert$(_coord$1, _tile$2, _board$3);
        return $2430;
    };
        ...
        switch (self._) {
                    ...
                    case 'App.KL.Game.Tile.new':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Entity.creature':
                                ...
                                switch (self._) {
                                    case 'App.KL.Game.Tile.new':
                                        var $2437 = self.terrain;
                                        var $2438 = App$KL$Game$Tile$new$($2437, Maybe$some$($2435));
                                        var _creature_tile$9 = $2438;
                                        break;
                                };
                                var $2436 = App$KL$Game$Board$set$(_coord$1, _creature_tile$9, _board$3);
                                var $2434 = $2436;
                                break;
                            case 'App.KL.Game.Entity.terrain':
                                ...
                                switch (self._) {
                                    case 'App.KL.Game.Tile.new':
                                        var $2440 = self.terrain;
                                        var $2441 = self.creature;
                                        var $2442 = App$KL$Game$Tile$new$($2440, $2441);
                                        var _background_tile$9 = $2442;
                                        break;
                                };
                                var $2439 = App$KL$Game$Board$set$(_coord$1, _background_tile$9, _board$3);
                                var $2434 = $2439;
                                break;
                        };
                        var $2433 = $2434;
            ...
            case 'Maybe.none':
                ...
                switch (self._) {
                    case 'App.KL.Game.Entity.terrain':
                        var $2444 = self.value;
                        var _new_tile$6 = App$KL$Game$Tile$new$($2444, Maybe$none);
                        var $2445 = App$KL$Game$Board$set$(_coord$1, _new_tile$6, _board$3);
                        var $2443 = $2445;
                        break;
                    case 'App.KL.Game.Entity.creature':
                        var $2446 = _board$3;
    ...
    const App$KL$Game$Board$arena = (() => {
        ...
        var _board$9 = (() => {
            ...
            var $2450 = _height$6;
            let _board$10 = $2448;
            for (let _j$9 = $2449; _j$9 < $2450; ++_j$9) {
                var _board$11 = (() => {
                    var $2451 = _board$10;
                    var $2452 = 0;
                    var $2453 = _width$4;
                    let _board$12 = $2451;
                    for (let _i$11 = $2452; _i$11 < $2453; ++_i$11) {
                        ...
                        var self = _inside$16;
                        if (self) {
                            var $2454 = App$KL$Game$Board$push$(_coord$15, _new_terrain$8, _board$12);
                            var $2451 = $2454;
                        } else {
                            var $2455 = _board$12;
                            var $2451 = $2455;
    ...
    function App$KL$Game$Phase$Draft$Hero$info$(_id$1) {
        var $2456 = App$KL$Game$Hero$get_by_id$((BigInt(_id$1)));
        return $2456;
    };
    ...
    function App$KL$Game$Phase$Draft$Tile$create_creature$(_hero_id$1, _player_addr$2, _team$3) {
        ...
        switch (self._) {
            case 'Maybe.some':
                var $2459 = self.value;
                var $2460 = Maybe$some$(App$KL$Game$Creature$new$(_player_addr$2, $2459, _team$3, (() => {
                    var self = $2459;
                    switch (self._) {
                        case 'App.KL.Game.Hero.new':
                            var $2461 = self.max_hp;
                            var $2462 = $2461;
                            return $2462;
                    };
                })(), (() => {
    ...
    function App$KL$Game$Phase$Draft$create_board$(_players$1) {
        var $2467 = ((console.log(" - criando mapa"), (_$2 => {
            ...
            var _map$5 = (() => {
                ...
                while ($2471._ === 'List.cons') {
                    ...
                    switch (self._) {
                        case 'App.KL.Game.Player.new':
                            var $2476 = self.init_pos;
                            var $2477 = $2476;
                            var _pos$9 = $2477;
                            break;
                    };
                    var $2470 = Maybe$default$(Maybe$monad$((_m$bind$10 => _m$pure$11 => {
                        var $2478 = _m$bind$10;
                        return $2478;
                    }))(_pos$9)((_coord$10 => {
                        var $2479 = Maybe$monad$((_m$bind$11 => _m$pure$12 => {
                            var $2480 = _m$bind$11;
                            return $2480;
                        }))(Maybe$map$(Nat$to_u8, (() => {
                            var self = _player$8;
                            ...
                            var $2483 = Maybe$monad$((_m$bind$13 => _m$pure$14 => {
                                var $2486 = _m$bind$13;
                                return $2486;
                                ...
                                var $2487 = Maybe$monad$((_m$bind$15 => _m$pure$16 => {
                                    var $2488 = _m$pure$16;
                                    return $2488;
    ...
    function App$KL$Game$Phase$Draft$tick$(_tick$1, _game$2) {
        ...
        switch (self._) {
            ...
            case 'List.cons':
                var self = _ready$5;
                if (self) {
                    var $2499 = ((console.log("- to_board"), (_$8 => {
                        var self = _game$2;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2501 = self.players;
                                var $2502 = self.board;
                                var $2503 = self.tick;
                                var $2504 = App$KL$Game$new$(App$KL$Game$Phase$play, $2501, $2502, $2503);
                                var _game$9 = $2504;
                                break;
                        };
                        var self = _game$9;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2505 = self.phase;
                                var $2506 = self.players;
                                var $2507 = self.tick;
                                var $2508 = App$KL$Game$new$($2505, $2506, App$KL$Game$Phase$Draft$create_board$(_players$3), $2507);
                                var _game$10 = $2508;
                                break;
                        };
                        var $2500 = _game$10;
    ...
    function App$KL$Game$Phase$Play$tick$(_tick$1, _game$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.new':
                var $2511 = self.phase;
                var $2512 = self.players;
                var $2513 = self.board;
                var $2514 = App$KL$Game$new$($2511, $2512, $2513, (((() => {
                    var self = _game$2;
                    switch (self._) {
                        case 'App.KL.Game.new':
                            var $2515 = self.tick;
    ...
    function App$KL$Game$tick$(_tick$1, _game$2) {
        ...
        switch (self._) {
            case 'App.KL.Game.new':
                ...
                switch (self._) {
                    case 'App.KL.Game.Phase.draft':
                        var $2520 = App$KL$Game$Phase$Draft$tick$(_tick$1, _game$2);
                        var $2519 = $2520;
                        break;
                    case 'App.KL.Game.Phase.play':
                        var $2521 = App$KL$Game$Phase$Play$tick$(_tick$1, _game$2);
                        var $2519 = $2521;
                        break;
                };
                var $2517 = $2519;
    ...
    function App$KL$Global$tick$(_tick$1, _glob$2) {
        ...
        switch (self._) {
            case 'Maybe.some':
                ...
                switch (self._) {
                    case 'App.KL.Global.State.new':
                        var $2527 = App$KL$Global$State$new$(Maybe$some$(App$KL$Game$tick$(_tick$1, $2525)));
                        var $2526 = $2527;
                        break;
                };
                var $2522 = $2526;
                            ...
                            case 'Maybe.some':
                                ...
                                switch (self._) {
                                    case 'Pair.new':
                                        var $2541 = self.fst;
                                        var $2542 = self.snd;
                                        var $2543 = Maybe$some$(Pair$new$($2541, $2542));
                                        var $2540 = $2543;
                                        break;
                                };
                                var $2538 = $2540;
                                break;
                            case 'Maybe.none':
                                var $2544 = Deserializer$choice$go$($2537, _bs$3);
                                var $2538 = $2544;
                                break;
                        };
                        return $2538;
    ...
    function Deserializer$choice$(_pars$2) {
        var $2546 = Deserializer$choice$go(_pars$2);
        return $2546;
    };
    ...
    function Deserializer$bits$(_bits$1, _bs$2) {
        ...
        while (true) {
            ...
            var R = (() => {
                ...
                switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                    case 'o':
                        var $2555 = self.slice(0, -1);
                        var self = _bs$2;
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'o':
                                var $2557 = self.slice(0, -1);
                                var $2558 = Deserializer$bits$($2555, $2557);
                                var $2556 = $2558;
                                break;
                            case 'e':
                            case 'i':
                        ...
                        return $2556;
                    case 'i':
                        var $2560 = self.slice(0, -1);
                        var self = _bs$2;
                        switch (self.length === 0 ? 'e' : self[self.length - 1] === '0' ? 'o' : 'i') {
                            case 'i':
                                var $2562 = self.slice(0, -1);
                                var $2563 = Deserializer$bits$($2560, $2562);
                                var $2561 = $2563;
                                break;
                            case 'e':
                            case 'o':
                        ...
                        return $2561;
                    case 'e':
                        var $2565 = Maybe$some$(Pair$new$(_bs$2, Unit$new));
                        return $2565;
                };
            })();
            if (R.ctr === 'TCO') arg = R.arg;
    ...
    function Deserializer$pure$(_value$2, _bs$3) {
        var $2566 = Maybe$some$(Pair$new$(_bs$3, _value$2));
        return $2566;
    };
    ...
    const App$KL$Game$Team$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits(((Bits$e + '0') + '0')))((_$1 => {
        var $2567 = Deserializer$pure(App$KL$Game$Team$blue);
        return $2567;
    })), List$cons$(Deserializer$bind(Deserializer$bits(((Bits$e + '0') + '1')))((_$1 => {
        var $2568 = Deserializer$pure(App$KL$Game$Team$red);
        return $2568;
    })), List$cons$(Deserializer$bind(Deserializer$bits(((Bits$e + '1') + '0')))((_$1 => {
        var $2569 = Deserializer$pure(App$KL$Game$Team$neutral);
        return $2569;
    })), List$nil))));

    function Deserializer$monad$(_new$2) {
        var $2570 = _new$2(Deserializer$bind)(Deserializer$pure);
        return $2570;
    };
    ...
    function Word$deserializer$(_size$1) {
        var self = _size$1;
        if (self === 0n) {
            var $2572 = Deserializer$monad$((_m$bind$2 => _m$pure$3 => {
                var $2573 = _m$pure$3;
                return $2573;
            }))(Word$e);
            var $2571 = $2572;
            ...
            var $2574 = (self - 1n);
            var $2575 = Deserializer$choice$(List$cons$(Deserializer$monad$((_m$bind$3 => _m$pure$4 => {
                var $2576 = _m$bind$3;
                return $2576;
            }))(Deserializer$bits((Bits$e + '0')))((_$3 => {
                var $2577 = Deserializer$monad$((_m$bind$4 => _m$pure$5 => {
                    var $2578 = _m$bind$4;
                    return $2578;
                }))(Word$deserializer$($2574))((_pred$4 => {
                    var $2579 = Deserializer$monad$((_m$bind$5 => _m$pure$6 => {
                        var $2580 = _m$pure$6;
                        return $2580;
                    }))(Word$o$(_pred$4));
                    return $2579;
                ...
                var $2582 = Deserializer$monad$((_m$bind$4 => _m$pure$5 => {
                    var $2583 = _m$bind$4;
                    return $2583;
                }))(Word$deserializer$($2574))((_pred$4 => {
                    var $2584 = Deserializer$monad$((_m$bind$5 => _m$pure$6 => {
                        var $2585 = _m$pure$6;
                        return $2585;
                    }))(Word$i$(_pred$4));
                    return $2584;
    ...
    const U8$deserializer = Deserializer$monad$((_m$bind$1 => _m$pure$2 => {
        ...
        var $2587 = Deserializer$monad$((_m$bind$2 => _m$pure$3 => {
            var $2588 = _m$pure$3;
            return $2588;
        }))(U8$new$(_word$1));
        return $2587;
    ...
    const I32$deserializer = Deserializer$monad$((_m$bind$1 => _m$pure$2 => {
        ...
        var $2590 = Deserializer$monad$((_m$bind$2 => _m$pure$3 => {
            var $2591 = _m$pure$3;
            return $2591;
        }))(I32$new$(_word$1));
        return $2590;
    ...
    const Hexagonal$Axial$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits(Bits$e))((_$1 => {
        var $2592 = Deserializer$bind(I32$deserializer)((_i$2 => {
            var $2593 = Deserializer$bind(I32$deserializer)((_j$3 => {
                var $2594 = Deserializer$pure(Hexagonal$Axial$new$(_i$2, _j$3));
                return $2594;
            }));
            return $2593;
        }));
    ...
    const App$KL$Game$Phase$Draft$Event$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '0') + '0')))((_$1 => {
        var $2595 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$join_room);
        return $2595;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '0') + '1')))((_$1 => {
        var $2596 = Deserializer$bind(App$KL$Game$Team$deserializer)((_team$2 => {
            var $2597 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_team$(_team$2));
            return $2597;
        }));
        return $2596;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '1') + '0')))((_$1 => {
        var $2598 = Deserializer$bind(U8$deserializer)((_hero$2 => {
            var $2599 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_hero$(_hero$2));
            return $2599;
        }));
        return $2598;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '0') + '1') + '1')))((_$1 => {
        var $2600 = Deserializer$bind(Hexagonal$Axial$deserializer)((_coord$2 => {
            var $2601 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_init_pos$(_coord$2));
            return $2601;
        }));
        return $2600;
    })), List$cons$(Deserializer$bind(Deserializer$bits((((Bits$e + '1') + '0') + '0')))((_$1 => {
        var $2602 = Deserializer$bind(U8$deserializer)((_ready$2 => {
            var $2603 = Deserializer$pure(App$KL$Game$Phase$Draft$Event$set_ready$(_ready$2));
            return $2603;
        }));
        return $2602;
    })), List$nil))))));
    const App$KL$Game$Phase$Play$Event$deserializer = Deserializer$choice$(List$nil);
    ...
    const App$KL$Game$Event$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '0')))((_$1 => {
        var $2605 = Deserializer$bind(App$KL$Game$Phase$Draft$Event$deserializer)((_event$2 => {
            var $2606 = Deserializer$pure(App$KL$Game$Event$draft$(_event$2));
            return $2606;
        }));
        return $2605;
    })), List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '1')))((_$1 => {
        var $2607 = Deserializer$bind(App$KL$Game$Phase$Play$Event$deserializer)((_event$2 => {
            var $2608 = Deserializer$pure(App$KL$Game$Event$play$(_event$2));
            return $2608;
        }));
        return $2607;
    })), List$nil)));
    const App$KL$Global$Event$deserializer = Deserializer$choice$(List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '0')))((_$1 => {
        var $2609 = Deserializer$pure(App$KL$Global$Event$void);
        return $2609;
    })), List$cons$(Deserializer$bind(Deserializer$bits((Bits$e + '1')))((_$1 => {
        var $2610 = Deserializer$bind(App$KL$Game$Event$deserializer)((_event$2 => {
            var $2611 = Deserializer$pure(App$KL$Global$Event$game$(_event$2));
            return $2611;
        }));
        return $2610;
    })), List$nil)));
    ...
    function Bits$hex$decode$(_x$1) {
        ...
        if (self.length === 0) {
            ...
            var $2614 = self.charCodeAt(0);
            var $2615 = self.slice(1);
            var self = ($2614 === 48);
            if (self) {
                var $2617 = ((((Bits$hex$decode$($2615) + '0') + '0') + '0') + '0');
                var $2616 = $2617;
            } else {
                var self = ($2614 === 49);
                if (self) {
                    var $2619 = ((((Bits$hex$decode$($2615) + '0') + '0') + '0') + '1');
                    var $2618 = $2619;
                } else {
                    var self = ($2614 === 50);
                    if (self) {
                        var $2621 = ((((Bits$hex$decode$($2615) + '0') + '0') + '1') + '0');
                        var $2620 = $2621;
                    } else {
                        var self = ($2614 === 51);
                        if (self) {
                            var $2623 = ((((Bits$hex$decode$($2615) + '0') + '0') + '1') + '1');
                            var $2622 = $2623;
                        } else {
                            var self = ($2614 === 52);
                            if (self) {
                                var $2625 = ((((Bits$hex$decode$($2615) + '0') + '1') + '0') + '0');
                                var $2624 = $2625;
                            } else {
                                var self = ($2614 === 53);
                                if (self) {
                                    var $2627 = ((((Bits$hex$decode$($2615) + '0') + '1') + '0') + '1');
                                    var $2626 = $2627;
                                } else {
                                    var self = ($2614 === 54);
                                    if (self) {
                                        var $2629 = ((((Bits$hex$decode$($2615) + '0') + '1') + '1') + '0');
                                        var $2628 = $2629;
                                    } else {
                                        var self = ($2614 === 55);
                                        if (self) {
                                            var $2631 = ((((Bits$hex$decode$($2615) + '0') + '1') + '1') + '1');
                                            var $2630 = $2631;
                                        } else {
                                            var self = ($2614 === 56);
                                            if (self) {
                                                var $2633 = ((((Bits$hex$decode$($2615) + '1') + '0') + '0') + '0');
                                                var $2632 = $2633;
                                            } else {
                                                var self = ($2614 === 57);
                                                if (self) {
                                                    var $2635 = ((((Bits$hex$decode$($2615) + '1') + '0') + '0') + '1');
                                                    var $2634 = $2635;
                                                } else {
                                                    var self = ($2614 === 97);
                                                    if (self) {
                                                        var $2637 = ((((Bits$hex$decode$($2615) + '1') + '0') + '1') + '0');
                                                        var $2636 = $2637;
                                                    } else {
                                                        var self = ($2614 === 98);
                                                        if (self) {
                                                            var $2639 = ((((Bits$hex$decode$($2615) + '1') + '0') + '1') + '1');
                                                            var $2638 = $2639;
                                                        } else {
                                                            var self = ($2614 === 99);
                                                            if (self) {
                                                                var $2641 = ((((Bits$hex$decode$($2615) + '1') + '1') + '0') + '0');
                                                                var $2640 = $2641;
                                                            } else {
                                                                var self = ($2614 === 100);
                                                                if (self) {
                                                                    var $2643 = ((((Bits$hex$decode$($2615) + '1') + '1') + '0') + '1');
                                                                    var $2642 = $2643;
                                                                } else {
                                                                    var self = ($2614 === 101);
                                                                    if (self) {
                                                                        var $2645 = ((((Bits$hex$decode$($2615) + '1') + '1') + '1') + '0');
                                                                        var $2644 = $2645;
                                                                    } else {
                                                                        var self = ($2614 === 102);
                                                                        if (self) {
                                                                            var $2647 = ((((Bits$hex$decode$($2615) + '1') + '1') + '1') + '1');
                                                                            var $2646 = $2647;
                                                                        } else {
                                                                            var self = ($2614 === 65);
                                                                            if (self) {
                                                                                var $2649 = ((((Bits$hex$decode$($2615) + '1') + '0') + '1') + '0');
                                                                                var $2648 = $2649;
                                                                            } else {
                                                                                var self = ($2614 === 66);
                                                                                if (self) {
                                                                                    var $2651 = ((((Bits$hex$decode$($2615) + '1') + '0') + '1') + '1');
                                                                                    var $2650 = $2651;
                                                                                } else {
                                                                                    var self = ($2614 === 67);
                                                                                    if (self) {
                                                                                        var $2653 = ((((Bits$hex$decode$($2615) + '1') + '1') + '0') + '0');
                                                                                        var $2652 = $2653;
                                                                                    } else {
                                                                                        var self = ($2614 === 68);
                                                                                        if (self) {
                                                                                            var $2655 = ((((Bits$hex$decode$($2615) + '1') + '1') + '0') + '1');
                                                                                            var $2654 = $2655;
                                                                                        } else {
                                                                                            var self = ($2614 === 69);
                                                                                            if (self) {
                                                                                                var $2657 = ((((Bits$hex$decode$($2615) + '1') + '1') + '1') + '0');
                                                                                                var $2656 = $2657;
                                                                                            } else {
                                                                                                var self = ($2614 === 70);
                                                                                                if (self) {
                                                                                                    var $2659 = ((((Bits$hex$decode$($2615) + '1') + '1') + '1') + '1');
                                                                                                    var $2658 = $2659;
                                                                                                } else {
                                                                                                    var $2660 = Bits$e;
                                                                                                    var $2658 = $2660;
    ...
    function App$KL$Global$Event$deserialize_post$(_hex$1) {
        var $2661 = Deserializer$run$(App$KL$Global$Event$deserializer, Bits$hex$decode$(String$drop$(2n, _hex$1)));
        return $2661;
    };
    ...
    const App$KL$Game$start = (() => {
        ...
        var _tick$4 = 0n;
        var $2662 = App$KL$Game$new$(_phase$1, _players$2, _board$3, _tick$4);
        return $2662;
    })();
    ...
    function App$KL$Game$Phase$Draft$has_hero$(_hero_id$1, _player$2) {
        ...
        switch (self._) {
            case 'Maybe.some':
                var $2669 = self.value;
                var $2670 = ((Number($2669) & 0xFF) === _hero_id$1);
                var $2664 = $2670;
                break;
            case 'Maybe.none':
                var $2671 = Bool$false;
    ...
    function App$KL$Game$Phase$Draft$has_coord$(_coord$1, _player$2) {
        ...
        switch (self._) {
            case 'Maybe.some':
                var $2677 = self.value;
                var $2678 = Hexagonal$Axial$eql$($2677, _coord$1);
                var $2672 = $2678;
                break;
            case 'Maybe.none':
                var $2679 = Bool$false;
    ...
    function App$KL$Game$Phase$Draft$post$(_time$1, _room$2, _addr$3, _event$4, _game$5) {
        ...
        switch (self._) {
            case 'App.KL.Game.Phase.Draft.Event.set_team':
                var $2681 = self.team;
                var $2682 = ((console.log("- set_team"), (_$7 => {
                    var self = _game$5;
                    switch (self._) {
                        case 'App.KL.Game.new':
                            var $2684 = self.phase;
                            var $2685 = self.board;
                            var $2686 = self.tick;
                            var $2687 = App$KL$Game$new$($2684, Map$set$(_addr$3, App$KL$Game$Player$new$(Maybe$none, Maybe$none, $2681, Bool$false), (() => {
                                var self = _game$5;
                                switch (self._) {
                                    case 'App.KL.Game.new':
            ...
            case 'App.KL.Game.Phase.Draft.Event.set_hero':
                var $2690 = self.hero;
                var $2691 = ((console.log("- set_hero"), (_$7 => {
                    var $2692 = Maybe$default$((() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2694 = self.players;
                                var $2695 = $2694;
                                var _players$8 = $2695;
                                break;
                        };
                        var $2693 = Maybe$monad$((_m$bind$9 => _m$pure$10 => {
                            var $2696 = _m$bind$9;
                            return $2696;
                        }))(Map$get$(_addr$3, _players$8))((_player$9 => {
                            var _player_list$10 = Map$to_list$(_players$8);
                            var _is_picked$11 = List$fold$(List$map$(App$KL$Game$Phase$Draft$has_hero($2690), _player_list$10), Bool$false, Bool$or);
                            var self = _game$5;
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    var $2698 = self.phase;
                                    var $2699 = self.board;
                                    var $2700 = self.tick;
                                    var $2701 = App$KL$Game$new$($2698, Map$set$(_addr$3, (() => {
                                        var self = _player$9;
                                        switch (self._) {
                                            case 'App.KL.Game.Player.new':
                                                var $2702 = self.init_pos;
                                                var $2703 = self.team;
                                                var $2704 = self.ready;
                                                var $2705 = App$KL$Game$Player$new$(Maybe$some$((BigInt($2690))), $2702, $2703, $2704);
                                                return $2705;
                                        };
                                    })(), _players$8), $2699, $2700);
                                    var _game$12 = $2701;
                                    break;
                            };
            ...
            case 'App.KL.Game.Phase.Draft.Event.set_init_pos':
                var $2708 = self.coord;
                var $2709 = ((console.log("- set_init_pos"), (_$7 => {
                    var $2710 = Maybe$default$((() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2712 = self.players;
                                var $2713 = $2712;
                                var _players$8 = $2713;
                                break;
                        };
                        var $2711 = Maybe$monad$((_m$bind$9 => _m$pure$10 => {
                            var $2714 = _m$bind$9;
                            return $2714;
                        }))(Map$get$(_addr$3, _players$8))((_player$9 => {
                            var _player_list$10 = Map$to_list$(_players$8);
                            var _is_occupied$11 = List$fold$(List$map$(App$KL$Game$Phase$Draft$has_coord($2708), _player_list$10), Bool$false, Bool$or);
                            var self = _game$5;
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    var $2716 = self.phase;
                                    var $2717 = self.board;
                                    var $2718 = self.tick;
                                    var $2719 = App$KL$Game$new$($2716, Map$set$(_addr$3, (() => {
                                        var self = _player$9;
                                        switch (self._) {
                                            case 'App.KL.Game.Player.new':
                                                var $2720 = self.hero_id;
                                                var $2721 = self.team;
                                                var $2722 = self.ready;
                                                var $2723 = App$KL$Game$Player$new$($2720, Maybe$some$($2708), $2721, $2722);
                                                return $2723;
                                        };
                                    })(), _players$8), $2717, $2718);
                                    var _game$12 = $2719;
                                    break;
                            };
            ...
            case 'App.KL.Game.Phase.Draft.Event.set_ready':
                var $2726 = self.ready;
                var $2727 = ((console.log("- set_ready"), (_$7 => {
                    var $2728 = Maybe$default$((() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2730 = self.players;
                                var $2731 = $2730;
                                var _players$8 = $2731;
                                break;
                        };
                        var $2729 = Maybe$monad$((_m$bind$9 => _m$pure$10 => {
                            var $2732 = _m$bind$9;
                            return $2732;
                        }))(Map$get$(_addr$3, _players$8))((_player$9 => {
                            var _ready$10 = ($2726 === 1);
                            var self = _game$5;
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    var $2734 = self.phase;
                                    var $2735 = self.board;
                                    var $2736 = self.tick;
                                    var $2737 = App$KL$Game$new$($2734, Map$set$(_addr$3, (() => {
                                        var self = _player$9;
                                        switch (self._) {
                                            case 'App.KL.Game.Player.new':
                                                var $2738 = self.hero_id;
                                                var $2739 = self.init_pos;
                                                var $2740 = self.team;
                                                var $2741 = App$KL$Game$Player$new$($2738, $2739, $2740, _ready$10);
                                                return $2741;
                                        };
                                    })(), _players$8), $2735, $2736);
                                    var _game$11 = $2737;
                                    break;
                            };
                            var $2733 = Maybe$some$(_game$11);
                            return $2733;
                        }));
                        return $2729;
                    })(), _game$5);
                ...
                break;
            case 'App.KL.Game.Phase.Draft.Event.join_room':
                var $2742 = ((console.log("- join_room"), (_$6 => {
                    var _player$7 = Map$get$(_addr$3, (() => {
                        var self = _game$5;
                        switch (self._) {
                            case 'App.KL.Game.new':
                                var $2744 = self.players;
                                var $2745 = $2744;
                                return $2745;
                        };
                    })());
                        ...
                        case 'Maybe.some':
                            ...
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    ...
                                    var $2749 = self.board;
                                    var $2750 = self.tick;
                                    var $2751 = App$KL$Game$new$($2748, Map$set$(_addr$3, $2746, (() => {
                                        var self = _game$5;
                                        switch (self._) {
                                            case 'App.KL.Game.new':
                        ...
                        case 'Maybe.none':
                            ...
                            switch (self._) {
                                case 'App.KL.Game.new':
                                    ...
                                    var $2756 = self.board;
                                    var $2757 = self.tick;
                                    var $2758 = App$KL$Game$new$($2755, Map$set$(_addr$3, App$KL$Game$Player$new$(Maybe$none, Maybe$none, App$KL$Game$Team$neutral, Bool$false), (() => {
                                        var self = _game$5;
                                        switch (self._) {
                                            case 'App.KL.Game.new':
            ...
            case 'App.KL.Game.new':
                ...
                switch (self._) {
                    case 'App.KL.Game.Event.draft':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Phase.draft':
                                var $2767 = App$KL$Game$Phase$Draft$post$(_time$1, _room$2, _addr$3, $2765, _game$5);
                                var $2766 = $2767;
                                break;
                            case 'App.KL.Game.Phase.play':
                                var $2768 = _game$5;
                    ...
                    case 'App.KL.Game.Event.play':
                        ...
                        switch (self._) {
                            case 'App.KL.Game.Phase.draft':
                                ...
                                break;
                            case 'App.KL.Game.Phase.play':
                                var $2772 = App$KL$Game$Phase$Play$post$(_time$1, _room$2, _addr$3, $2769, _game$5);
                                var $2770 = $2772;
                                break;
                        };
                        var $2764 = $2770;
            ...
            case 'Maybe.some':
                ...
                switch (self._) {
                    case 'App.KL.Global.Event.game':
                        ...
                        switch (self._) {
                            case 'App.KL.Global.State.new':
                                var $2780 = App$KL$Global$State$new$(Maybe$some$(App$KL$Game$post$(_time$1, _room$2, _addr$3, $2776, _game$8)));
                                var $2777 = $2780;
                                break;
                        };
                        var $2775 = $2777;
    ...
    const App$KL = (() => {
        ...
        var $2783 = App$new$(App$KL$init, App$KL$draw(_img$1), App$KL$when, App$KL$Global$tick, App$KL$Global$post);
        return $2783;
    })();
    return {
