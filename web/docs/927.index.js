...
module.exports = (function() {
    ...
    const Web$Kaelin$Heroes$Croni$skills$quick_shot = Web$Kaelin$Skill$new$(1, 2n, List$cons$(Web$Kaelin$Skill$Effect$hp$((Number((7n))), Web$Kaelin$Skill$Modifier$hp$damage, Web$Kaelin$Skill$area$radial$(1n), Maybe$some$(Web$Kaelin$Skill$area$indicator$red)), List$nil), 48);
    ...
    const Web$Kaelin$Heroes$Croni$skills$vampirism = Web$Kaelin$Skill$new$(4, 3n, List$cons$(Web$Kaelin$Skill$Effect$hp$((Number((5n))), Web$Kaelin$Skill$Modifier$hp$damage, Web$Kaelin$Skill$area$single, Maybe$some$(Web$Kaelin$Skill$area$indicator$red)), List$cons$(Web$Kaelin$Skill$Effect$hp$((Number((8n))), Web$Kaelin$Skill$Modifier$hp$heal, Web$Kaelin$Skill$area$self, Maybe$some$(Web$Kaelin$Skill$area$indicator$green)), List$nil)), 86);
    ...
    function Web$Kaelin$Skill$move$(_range$1) {
        var $374 = Web$Kaelin$Skill$new$(1, _range$1, List$cons$(Web$Kaelin$Skill$Effect$position$((Number((0n))), Web$Kaelin$Skill$Modifier$position$move_to, Web$Kaelin$Skill$area$single, Maybe$some$(Web$Kaelin$Skill$area$indicator$blue)), List$nil), 88);
        return $374;
    };
    ...
    function Web$Kaelin$App$draw$(_img$1, _state$2) {
        ...
        switch (self._) {
            ...
            case 'Web.Kaelin.State.void':
                ...
                break;
            case 'Web.Kaelin.State.game':
                var $824 = DOM$vbox$(Map$from_list$(List$nil), Map$from_list$(List$nil), Web$Kaelin$Draw$state$(_img$1, _state$2));
                var $822 = $824;
                break;
        };
        return $822;
            ...
            case 'Parser.State.new':
                ...
                switch (self._) {
                    case 'Parser.Reply.value':
                        var $1209 = self.pst;
                        var $1210 = self.val;
                        var $1211 = Parser$Reply$value$($1209, Maybe$some$($1210));
                        var $1208 = $1211;
                        break;
                    case 'Parser.Reply.error':
                        var $1212 = Parser$Reply$value$(_pst$3, Maybe$none);
                        var $1208 = $1212;
                        break;
                };
                var $1207 = $1208;
            ...
            var R = (() => {
                ...
                switch (self._) {
                    case 'Parser.State.new':
                        ...
                        var self = _text$3;
                        if (self.length === 0) {
                            var $1222 = Parser$Reply$value$(_pst$4, Unit$new);
                            var $1221 = $1222;
                        } else {
                            var $1223 = self.charCodeAt(0);
                            var $1224 = self.slice(1);
                            var self = $1220;
                            if (self.length === 0) {
                                var _error_msg$12 = ("Expected \'" + (_ini_txt$2 + "\', found end of file."));
                                var $1226 = Parser$Reply$fail$($1217, $1218, _ini_idx$1, _error_msg$12);
                                var $1225 = $1226;
                            } else {
                                var $1227 = self.charCodeAt(0);
                                var $1228 = self.slice(1);
                                var self = ($1223 === $1227);
                                if (self) {
                                    var _pst$14 = Parser$State$new$($1216, $1217, $1218, Nat$succ$($1219), $1228);
                                    var $1230 = Parser$text$go$(_ini_idx$1, _ini_txt$2, $1224, _pst$14);
                                    var $1229 = $1230;
                                } else {
                                    var _chr$14 = String$cons$($1227, String$nil);
                                    var _err$15 = ("Expected \'" + (_ini_txt$2 + ("\', found \'" + (_chr$14 + "\'."))));
                                    var $1231 = Parser$Reply$fail$($1217, $1218, _ini_idx$1, _err$15);
                                    var $1229 = $1231;
                                };
                                var $1225 = $1229;
                            };
            ...
            case 'Parser.State.new':
                ...
                switch (self._) {
                    ...
                    case 'Parser.Reply.value':
                        var $1237 = self.pst;
                        var $1238 = self.val;
                        var $1239 = Parser$Reply$value$($1237, $1238);
                        var $1234 = $1239;
                        break;
                };
                var $1232 = $1234;
        ...
        switch (self._) {
            case 'Maybe.some':
                ...
                switch (self._) {
                    case 'Maybe.some':
                        var $1250 = self.value;
                        var $1251 = Maybe$some$(Parser$Error$combine$($1248, $1250));
                        var $1249 = $1251;
                        break;
                    case 'Maybe.none':
                        var $1252 = _a$1;
                    ...
                    case 'Parser.State.new':
                        ...
                        switch (self._) {
                            case 'Parser.Reply.value':
                                var $1257 = self.pst;
                                var $1258 = self.val;
                                var $1259 = Parser$many$go$(_parse$2, (_xs$12 => {
                                    var $1260 = _values$3(List$cons$($1258, _xs$12));
                                    return $1260;
                                }), $1257);
                                var $1256 = $1259;
                                break;
                            case 'Parser.Reply.error':
                                var $1261 = Parser$Reply$value$(_pst$4, _values$3(List$nil));
                                var $1256 = $1261;
                                break;
                        };
                        return $1256;
                ...
                switch (self._) {
                    case 'Parser.Reply.error':
                        ...
                        switch (self._) {
                            case 'Maybe.some':
                                var $1269 = self.value;
                                var $1270 = Parser$Reply$error$(Parser$Error$combine$($1269, $1267));
                                var $1268 = $1270;
                                break;
                            case 'Maybe.none':
                                var $1271 = Parser$Reply$error$($1267);
                                var $1268 = $1271;
                                break;
                        };
                        var $1266 = $1268;
                    ...
                    case 'Parser.Reply.value':
                        ...
                        switch (self._) {
                            case 'Parser.State.new':
                                ...
                                var $1278 = self.idx;
                                var $1279 = self.str;
                                var _reply$pst$17 = Parser$State$new$(Parser$Error$maybe_combine$($1265, $1275), $1276, $1277, $1278, $1279);
                                            ...
                                            case 'Parser.Reply.value':
                                                ...
                                                switch (self._) {
                                                    case 'Parser.State.new':
                                                        ...
                                                        var $1294 = self.idx;
                                                        var $1295 = self.str;
                                                        var _reply$pst$31 = Parser$State$new$(Parser$Error$maybe_combine$($1281, $1291), $1292, $1293, $1294, $1295);
                                                        var $1296 = Parser$Reply$value$(_reply$pst$31, List$cons$($1273, $1289));
                                                        var $1290 = $1296;
                                                        break;
                                                };
                                                var $1282 = $1290;
    ...
    function Parser$one$(_pst$1) {
        ...
        switch (self._) {
            case 'Parser.State.new':
                ...
                var self = $1302;
                if (self.length === 0) {
                    var $1304 = Parser$Reply$fail$($1299, $1300, $1301, "Unexpected end of file.");
                    var $1303 = $1304;
                } else {
                    var $1305 = self.charCodeAt(0);
                    var $1306 = self.slice(1);
                    var _pst$9 = Parser$State$new$($1298, $1299, $1300, Nat$succ$($1301), $1306);
                    var $1307 = Parser$Reply$value$(_pst$9, $1305);
                    var $1303 = $1307;
                };
                var $1297 = $1303;
                break;
    ...
    function Parser$fail$(_error$2, _pst$3) {
        ...
        switch (self._) {
            case 'Parser.State.new':
                ...
                var $1357 = self.ini;
                var $1358 = self.idx;
                var $1359 = Parser$Reply$fail$($1356, $1357, $1358, _error$2);
                var $1355 = $1359;
                break;
        };
        return $1355;
                    ...
                    switch (self._) {
                        case 'Parser.Reply.error':
                            ...
                            switch (self._) {
                                case 'Maybe.some':
                                    var $1366 = self.value;
                                    var $1367 = Parser$Reply$error$(Parser$Error$combine$($1366, $1364));
                                    var $1365 = $1367;
                                    break;
                                case 'Maybe.none':
                                    var $1368 = Parser$Reply$error$($1364);
                                    var $1365 = $1368;
                                    break;
                            };
                            var $1363 = $1365;
                        ...
                        case 'Parser.Reply.value':
                            ...
                            switch (self._) {
                                case 'Parser.State.new':
                                    ...
                                    var $1375 = self.idx;
                                    var $1376 = self.str;
                                    var _reply$pst$16 = Parser$State$new$(Parser$Error$maybe_combine$($1362, $1372), $1373, $1374, $1375, $1376);
                                    var _k$17 = Hex$char_hex_to_nat$($1370);
                                    var self = _k$17;
                                    switch (self._) {
                                        case 'Maybe.some':
                                            var $1378 = self.value;
                                            var $1379 = (_pst$19 => {
                                                var $1380 = Parser$Reply$value$(_pst$19, $1378);
                                                return $1380;
                                            });
                                            var $1377 = $1379;
                                            break;
                                        case 'Maybe.none':
                                            var $1381 = Parser$fail("Hex lexical error");
                                            var $1377 = $1381;
                                            break;
                                    };
                                    var $1377 = $1377(_reply$pst$16);
                                    var $1371 = $1377;
                                    break;
                            };
                            var $1363 = $1371;
            ...
            var R = (() => {
                ...
                switch (self._) {
                    case 'List.cons':
                        var $1382 = self.head;
                        var $1383 = self.tail;
                        var $1384 = List$fold_right$(null, null, _f$4($1382)(_b$3), _f$4, $1383);
                        return $1384;
                    case 'List.nil':
                        var $1385 = _b$3;
                        return $1385;
        ...
        while (true) {
            ...
            var R = (() => {
                var _shift1_Nat$4 = (_x$4 => {
                    var $1387 = Bits$to_nat$(Bits$shift_right$(1n, (nat_to_bits(_x$4))));
                    return $1387;
                });
                var _n$5 = (2n * (_x$1 % 2n));
                var _z$6 = (_z$3 + 1n);
                var self = (_x$1 > 0n);
                if (self) {
                    var $1388 = append_2_go$(_shift1_Nat$4(_x$1), (_y$2 + (_n$5 ** _z$6)), _z$6);
                    var $1386 = $1388;
                } else {
                    var $1389 = _y$2;
                    var $1386 = $1389;
    ...
    function Nat$append_2$(_b$1, _x$2, _y$3) {
        var $1390 = append_2_go$(_x$2, _y$3, _b$1);
        return $1390;
    };
    const Nat$append_2 = x0 => x1 => x2 => Nat$append_2$(x0, x1, x2);

    function Hex$parser$(_pst$1) {
        var self = _pst$1;
        switch (self._) {
            case 'Parser.State.new':
                var $1392 = self.err;
                    ...
                    case 'Parser.Reply.value':
                        ...
                        switch (self._) {
                            case 'Parser.State.new':
                                ...
                                var $1404 = self.idx;
                                var $1405 = self.str;
                                var _reply$pst$15 = Parser$State$new$(Parser$Error$maybe_combine$($1392, $1401), $1402, $1403, $1404, $1405);
                                var self = _reply$pst$15;
                                switch (self._) {
                                    case 'Parser.State.new':
                                        var $1407 = self.err;
                                        var _reply$21 = Parser$many1$(Hex$parser$char_hex, _reply$pst$15);
                                        var self = _reply$21;
                                        switch (self._) {
                                            case 'Parser.Reply.error':
                                                var $1409 = self.err;
                                                ...
                                                switch (self._) {
                                                    case 'Maybe.some':
                                                        var $1411 = self.value;
                                                        var $1412 = Parser$Reply$error$(Parser$Error$combine$($1411, $1409));
                                                        var $1410 = $1412;
                                                        break;
                                                    case 'Maybe.none':
                                                        var $1413 = Parser$Reply$error$($1409);
                                                        var $1410 = $1413;
                                                        break;
                                                };
                                                var $1408 = $1410;
                                            ...
                                            case 'Parser.Reply.value':
                                                ...
                                                switch (self._) {
                                                    case 'Parser.State.new':
                                                        ...
                                                        var $1420 = self.idx;
                                                        var $1421 = self.str;
                                                        var _reply$pst$29 = Parser$State$new$(Parser$Error$maybe_combine$($1407, $1417), $1418, $1419, $1420, $1421);
                                                        var $1422 = Parser$Reply$value$(_reply$pst$29, (() => {
                                                            var self = $1415;
                                                            switch (self._) {
                                                                case 'List.cons':
                                                                    var $1423 = self.head;
                                                                    var $1424 = self.tail;
                                                                    var $1425 = List$fold_right$(null, null, $1423, Function$flip(Nat$append_2(3n)), $1424);
                                                                    return $1425;
                                                                case 'List.nil':
                                                                    var $1426 = 0n;
                                                                    return $1426;
    ...
    const Hex$parser = x0 => Hex$parser$(x0);
    ...
    function Web$Kaelin$Map$player$info$(_addr$1, _map$2) {
        ...
        var $1498 = Web$Kaelin$Map$player$info$go$(_addr$1, _lmap$3);
        return $1498;
    };
            ...
            var R = (() => {
                ...
                switch (self._) {
                    case 'List.cons':
                        var $1499 = self.head;
                        var $1500 = self.tail;
                        var self = _cond$2($1499);
                        if (self) {
                            var $1502 = Maybe$some$($1499);
                            var $1501 = $1502;
                        } else {
                            var $1503 = List$find$(_cond$2, $1500);
                            var $1501 = $1503;
                        };
                        return $1501;
                    case 'List.nil':
            ...
            var R = (() => {
                ...
                if (self === 0n) {
                    ...
                    if (self.length === 0) {
                        ...
                        var $1557 = self.charCodeAt(0);
                        var $1558 = self.slice(1);
                        var $1559 = String$drop$($1554, $1558);
                        var $1555 = $1559;
                    };
                    return $1555;
                };
            ...
            case 'Pair.new':
                ...
                switch (self._) {
                    case 'List.cons':
                        var $1564 = self.head;
                        var $1565 = self.tail;
                        var $1566 = Pair$new$(String$drop$((BigInt($1564)), $1561), $1565);
                        var $1563 = $1566;
                        break;
                    case 'List.nil':
                        var $1567 = _buffer$1;
    ...
    function String$take$(_n$1, _xs$2) {
        ...
        if (self.length === 0) {
            ...
            var $1570 = self.charCodeAt(0);
            var $1571 = self.slice(1);
            var self = _n$1;
            if (self === 0n) {
                var $1573 = String$nil;
                var $1572 = $1573;
                ...
                var $1574 = (self - 1n);
                var $1575 = String$cons$($1570, String$take$($1574, $1571));
                var $1572 = $1575;
            };
            var $1568 = $1572;
        };
        ...
        switch (self._) {
            case 'Pair.new':
                ...
                switch (self._) {
                    case 'List.cons':
                        var $1580 = self.head;
                        var $1581 = Hex$to_nat$(String$take$((BigInt($1580)), $1577));
                        var $1579 = $1581;
                        break;
                    case 'List.nil':
                        var $1582 = 0n;
    ...
    function Web$Kaelin$Resources$Action$to_action$(_x$1) {
        ...
        if (self) {
            ...
            var self = (_x$1 === 1n);
            if (self) {
                var $1592 = Maybe$some$(Web$Kaelin$Action$ability_0);
                var $1591 = $1592;
            } else {
                var self = (_x$1 === 2n);
                if (self) {
                    var $1594 = Maybe$some$(Web$Kaelin$Action$ability_1);
                    var $1593 = $1594;
                } else {
                    var $1595 = Maybe$none;
                    var $1593 = $1595;
    ...
    function Web$Kaelin$Event$deserialize$(_code$1) {
        ...
        if (self) {
            var _stream$3 = (_x$3 => {
                var $1603 = Web$Kaelin$Event$Buffer$next$(_x$3);
                return $1603;
            })(_stream$2);
            var _stream$4 = (_x$4 => _y$5 => {
                var $1604 = Web$Kaelin$Event$Buffer$push$(_x$4, _y$5);
                return $1604;
            })(_stream$3)(Web$Kaelin$Event$Code$create_hero);
            var $1602 = Maybe$some$(Web$Kaelin$Event$create_hero$((Number((_x$5 => {
                var $1605 = Web$Kaelin$Event$Buffer$get$(_x$5);
                return $1605;
            })(_stream$4)) & 0xFF)));
            var $1600 = $1602;
        } else {
            var self = ((_x$3 => {
                var $1607 = Web$Kaelin$Event$Buffer$get$(_x$3);
                return $1607;
            })(_stream$2) === 4n);
            if (self) {
                var _stream$3 = (_x$3 => {
                    var $1609 = Web$Kaelin$Event$Buffer$next$(_x$3);
                    return $1609;
                })(_stream$2);
                var _stream$4 = (_x$4 => _y$5 => {
                    var $1610 = Web$Kaelin$Event$Buffer$push$(_x$4, _y$5);
                    return $1610;
                })(_stream$3)(Web$Kaelin$Event$Code$user_input);
                var _player$5 = Bits$to_hex_string$((nat_to_bits((_x$5 => {
                    var $1611 = Web$Kaelin$Event$Buffer$get$(_x$5);
                    return $1611;
                })(_stream$4))));
                var _stream$6 = (_x$6 => {
                    var $1612 = Web$Kaelin$Event$Buffer$next$(_x$6);
                    return $1612;
                })(_stream$4);
                var _action$7 = Web$Kaelin$Resources$Action$to_action$((_x$7 => {
                    var $1613 = Web$Kaelin$Event$Buffer$get$(_x$7);
                    return $1613;
                })(_stream$6));
                var _stream$8 = (_x$8 => {
                    var $1614 = Web$Kaelin$Event$Buffer$next$(_x$8);
                    return $1614;
                })(_stream$6);
                var _pos$9 = Web$Kaelin$Coord$Convert$nat_to_axial$((_x$9 => {
                    var $1615 = Web$Kaelin$Event$Buffer$get$(_x$9);
                    return $1615;
                })(_stream$8));
                var $1608 = Maybe$bind$(_action$7, (_action$10 => {
                    var $1616 = Maybe$some$(Web$Kaelin$Event$user_input$(("0x" + _player$5), _pos$9, _action$10));
                    return $1616;
                }));
                var $1606 = $1608;
            } else {
    ...
    function Web$Kaelin$Map$find_players$(_map$1) {
                ...
                switch (self._) {
                    case 'Pair.new':
                        ...
                        var _players$11 = (() => {
                            var $1626 = _players$4;
                            var $1627 = _tile$10;
                            let _players$12 = $1626;
                            let _entity$11;
                            while ($1627._ === 'List.cons') {
                                _entity$11 = $1627.head;
                                var self = _entity$11;
                                switch (self._) {
                                    case 'Web.Kaelin.Entity.creature':
                                        var $1628 = self.player;
                                        var self = $1628;
                                        switch (self._) {
                                            case 'Maybe.some':
                                                var $1630 = self.value;
                                                var _axial_coord$16 = Web$Kaelin$Coord$Convert$nat_to_axial$(_coord$9);
                                                var $1631 = List$cons$(Pair$new$($1630, _axial_coord$16), List$nil);
                                                var $1629 = $1631;
                                                break;
                                            case 'Maybe.none':
                                                var $1632 = _players$12;
                                                var $1629 = $1632;
                                                break;
                                        };
                                        var $1626 = $1629;
                        ...
                        var $1624 = List$concat$(_result$6, _players$11);
                        var $1620 = $1624;
                        break;
                };
                _result$6 = $1620;
        ...
        var $1618 = Map$from_list$(_result$5);
        return $1618;
    };
    ...
    function Web$Kaelin$Map$player$to_coord$(_addr$1, _map$2) {
        ...
        var $1634 = Map$get$(_addr$1, _list$3);
        return $1634;
    };
        ...
        switch (self._) {
            case 'Maybe.some':
                ...
                var _addr$6 = (() => {
                    ...
                    let _addr$7 = $1639;
                    let _entity$6;
                    while ($1640._ === 'List.cons') {
                        _entity$6 = $1640.head;
                        var self = _entity$6;
                        switch (self._) {
                            case 'Web.Kaelin.Entity.creature':
                                var $1641 = self.player;
                                var self = $1641;
                                switch (self._) {
                                    case 'Maybe.some':
                                        var $1643 = self.value;
                                        var $1644 = Maybe$some$($1643);
                                        var $1642 = $1644;
                                        break;
                                    case 'Maybe.none':
                                        var $1645 = _addr$7;
    ...
    function Web$Kaelin$Skill$updated_player_hp$(_player$1, _modifier$2, _value$3) {
        ...
        switch (self._) {
            case 'Web.Kaelin.Player.new':
                var $1649 = self.addr;
                var $1650 = self.team;
                var $1651 = self.current_hp;
                var $1652 = self.current_status;
                var self = _modifier$2;
                switch (self._) {
                    case 'Web.Kaelin.Skill.Modifier.hp.damage':
                        var _damaged$8 = (($1651 - _value$3) >> 0);
                        var $1654 = Web$Kaelin$Player$new$($1649, $1650, _damaged$8, $1652);
                        var $1653 = $1654;
                        break;
                    case 'Web.Kaelin.Skill.Modifier.hp.heal':
                        var _healed$8 = ((_value$3 + $1651) >> 0);
                        var $1655 = Web$Kaelin$Player$new$($1649, $1650, _healed$8, $1652);
                        var $1653 = $1655;
                        break;
                };
                var $1648 = $1653;
                ...
                if (self === 0n) {
                    ...
                    switch (self._) {
                        case 'List.cons':
                            var $1657 = self.head;
                            var $1658 = self.tail;
                            var $1659 = Pair$new$(Maybe$some$($1657), List$concat$(_searched_list$4, $1658));
                            var $1656 = $1659;
                            break;
                        case 'List.nil':
                            var $1660 = Pair$new$(Maybe$none, _searched_list$4);
                            var $1656 = $1660;
                            break;
                    };
                    return $1656;
                    ...
                    switch (self._) {
                        case 'List.cons':
                            var $1663 = self.head;
                            var $1664 = self.tail;
                            var $1665 = List$pop_at$go$($1661, $1664, List$concat$(_searched_list$4, List$cons$($1663, List$nil)));
                            var $1662 = $1665;
                            break;
                        case 'List.nil':
                            var $1666 = Pair$new$(Maybe$none, _searched_list$4);
                            var $1662 = $1666;
                            break;
                    };
                    return $1662;
    ...
    function List$pop_at$(_idx$2, _list$3) {
        var $1667 = List$pop_at$go$(_idx$2, _list$3, List$nil);
        return $1667;
    };
    ...
    function Web$Kaelin$Map$pop_at$(_idx$1, _coord$2, _map$3) {
        ...
        switch (self._) {
            case 'Maybe.some':
                var $1669 = self.value;
                var self = List$pop_at$(_idx$1, $1669);
                switch (self._) {
                    case 'Pair.new':
                        var $1671 = self.fst;
                        var $1672 = self.snd;
                        var _map$8 = Web$Kaelin$Map$set$(_coord$2, $1672, _map$3);
                        var $1673 = Pair$new$(_map$8, $1671);
                        var $1670 = $1673;
                        break;
                };
                var $1668 = $1670;
                break;
            case 'Maybe.none':
                var $1674 = Pair$new$(_map$3, Maybe$none);
                var $1668 = $1674;
                break;
        };
        return $1668;
        ...
        switch (self._) {
            case 'Pair.new':
                ...
                switch (self._) {
                    case 'Maybe.some':
                        var $1679 = self.value;
                        var $1680 = Web$Kaelin$Map$push$(_cb$3, $1679, $1676);
                        var $1678 = $1680;
                        break;
                    case 'Maybe.none':
                        var $1681 = _map$4;
    ...
    function Web$Kaelin$Skill$updated_player_position$(_map$1, _hero_coord$2, _target_coord$3, _mod$4, _value$5) {
        ...
        switch (self._) {
            case 'Web.Kaelin.Skill.Modifier.position.move_to':
                var $1683 = Pair$new$(_hero_coord$2, _target_coord$3);
                var self = $1683;
                break;
        };
        switch (self._) {
            case 'Pair.new':
                var $1684 = self.fst;
                var $1685 = self.snd;
                var $1686 = Web$Kaelin$Map$swap$(0n, $1684, $1685, _map$1);
                var $1682 = $1686;
                break;
        };
        return $1682;
    ...
    function Web$Kaelin$Map$is_occupied$(_coord$1, _map$2) {
        ...
        var _is_occupied$5 = (() => {
            var $1689 = _is_occupied$4;
            var $1690 = _tile$3;
            let _is_occupied$6 = $1689;
            let _ent$5;
            while ($1690._ === 'List.cons') {
                _ent$5 = $1690.head;
                var self = _ent$5;
                switch (self._) {
                    case 'Web.Kaelin.Entity.background':
                        var $1691 = (_is_occupied$6 || Bool$false);
                        var $1689 = $1691;
                        break;
                    case 'Web.Kaelin.Entity.creature':
                        var $1692 = Bool$true;
    ...
    function Web$Kaelin$Skill$updated_player_status$(_player$1, _modifier$2, _value$3) {
        ...
        switch (self._) {
            case 'Web.Kaelin.Player.new':
                var $1694 = self.addr;
                var $1695 = self.team;
                var $1696 = self.current_hp;
                var $1697 = self.current_status;
                var self = _modifier$2;
                switch (self._) {
                    ...
                    case 'Web.Kaelin.Skill.Modifier.status.root':
                        var $1699 = Web$Kaelin$Player$new$($1694, $1695, $1696, List$cons$(_modifier$2, $1697));
                        var $1698 = $1699;
                        break;
                    case 'Web.Kaelin.Skill.Modifier.status.cleanse':
                        var $1700 = Web$Kaelin$Player$new$($1694, $1695, $1696, List$nil);
                        var $1698 = $1700;
                        break;
                };
                var $1693 = $1698;
    ...
    function Web$Kaelin$Skill$update_state$(_state$1, _hero_pos$2, _target$3, _effect$4) {
        ...
        switch (self._) {
            case 'Web.Kaelin.State.game':
                var $1702 = self.user;
                var $1703 = self.room;
                var $1704 = self.players;
                var $1705 = self.cast_info;
                var $1706 = self.map;
                var $1707 = self.internal;
                var $1708 = self.env_info;
                var _player$12 = Web$Kaelin$Map$coord_to_address$(_target$3, $1706);
                var self = _effect$4;
                switch (self._) {
                    case 'Web.Kaelin.Skill.Effect.hp':
                        var $1710 = self.value;
                        var $1711 = self.modifier;
                        var self = _player$12;
                        switch (self._) {
                            case 'Maybe.some':
                                var $1713 = self.value;
                                var _player$address$18 = Map$get$($1713, $1704);
                                var self = _player$address$18;
                                switch (self._) {
                                    case 'Maybe.some':
                                        var $1715 = self.value;
                                        var _new_hp$20 = Web$Kaelin$Skill$updated_player_hp$($1715, $1711, $1710);
                                        var _new_players_hp$21 = Map$set$($1713, _new_hp$20, $1704);
                                        var $1716 = Web$Kaelin$State$game$($1702, $1703, _new_players_hp$21, $1705, $1706, $1707, $1708);
                                        var $1714 = $1716;
                                        break;
                                    case 'Maybe.none':
                                        var $1717 = _state$1;
                    ...
                    case 'Web.Kaelin.Skill.Effect.position':
                        var $1719 = self.value;
                        var $1720 = self.modifier;
                        var _new_map$17 = Web$Kaelin$Skill$updated_player_position$($1706, _hero_pos$2, _target$3, $1720, $1719);
                        var self = (!Web$Kaelin$Map$is_occupied$(_target$3, $1706));
                        if (self) {
                            var $1722 = Web$Kaelin$State$game$($1702, $1703, $1704, $1705, _new_map$17, $1707, $1708);
                            var $1721 = $1722;
                        } else {
                            var $1723 = _state$1;
                            var $1721 = $1723;
                        ...
                        break;
                    case 'Web.Kaelin.Skill.Effect.status':
                        var $1724 = self.duration;
                        var $1725 = self.modifier;
                        var self = _player$12;
                        switch (self._) {
                            case 'Maybe.some':
                                var $1727 = self.value;
                                var _player$address$18 = Map$get$($1727, $1704);
                                var self = _player$address$18;
                                switch (self._) {
                                    case 'Maybe.some':
                                        var $1729 = self.value;
                                        var _new_effect$20 = Web$Kaelin$Skill$updated_player_status$($1729, $1725, $1724);
                                        var _new_players_effect$21 = Map$set$($1727, _new_effect$20, $1704);
                                        var $1730 = Web$Kaelin$State$game$($1702, $1703, _new_players_effect$21, $1705, $1706, $1707, $1708);
                                        var $1728 = $1730;
                                        break;
                                    case 'Maybe.none':
                                        var $1731 = _state$1;
    ...
    function Web$Kaelin$Skills$skill_use$aux$(_state$1) {
        ...
        switch (self._) {
            case 'Web.Kaelin.State.game':
                var $1735 = self.user;
                var $1736 = self.room;
                var $1737 = self.players;
                var $1738 = self.map;
                var $1739 = self.internal;
                var $1740 = self.env_info;
                var $1741 = Web$Kaelin$State$game$($1735, $1736, $1737, Maybe$none, $1738, $1739, $1740);
                var $1734 = $1741;
                break;
            case 'Web.Kaelin.State.init':
            case 'Web.Kaelin.State.void':
            ...
            case 'Web.Kaelin.State.game':
                ...
                switch (self._) {
                    case 'Maybe.some':
                        ...
                        switch (self._) {
                            case 'App.EnvInfo.new':
                                var $1749 = self.mouse_pos;
                                var self = $1747;
                                switch (self._) {
                                    case 'Web.Kaelin.CastInfo.new':
                                        var $1751 = self.hero_pos;
                                        var $1752 = self.skill;
                                        var $1753 = self.range;
                                        var $1754 = self.mouse_pos;
                                        var _skill$18 = $1752;
                                        var self = _skill$18;
                                        switch (self._) {
                                            case 'Web.Kaelin.Skill.new':
                                                var $1756 = self.effects;
                                                var _mouse_pos$23 = Web$Kaelin$Coord$to_axial$($1749);
                                                var self = List$any$(Web$Kaelin$Coord$eql(_mouse_pos$23), $1753);
                                                if (self) {
                                                    var _state$24 = (() => {
                                                        var $1760 = _state$1;
                                                        var $1761 = $1756;
                                                        let _state$25 = $1760;
                                                        let _effect$24;
                                                        while ($1761._ === 'List.cons') {
                                                            _effect$24 = $1761.head;
                                                            var self = _effect$24;
                                                            switch (self._) {
                                                                case 'Web.Kaelin.Skill.Effect.hp':
                                                                    var $1762 = self.area;
                                                                    var _area$30 = Web$Kaelin$Skill$area$to_list$($1762, $1751, $1754);
                                                                    var _state$31 = (() => {
                                                                        var $1765 = _state$25;
                                                                        var $1766 = _area$30;
                                                                        let _state$32 = $1765;
                                                                        let _coord$31;
                                                                        while ($1766._ === 'List.cons') {
                                                                            _coord$31 = $1766.head;
                                                                            var $1765 = Web$Kaelin$Skill$update_state$(_state$32, $1751, _coord$31, _effect$24);
                                                                            _state$32 = $1765;
                                                                            $1766 = $1766.tail;
                                                                        }
                                                                        return _state$32;
                                                                    })();
                                                                    var $1763 = Web$Kaelin$Skills$skill_use$aux$(_state$31);
                                                                    var $1760 = $1763;
                                                                    break;
                                                                case 'Web.Kaelin.Skill.Effect.position':
                                                                    var $1767 = self.area;
                                                                    var _area$30 = Web$Kaelin$Skill$area$to_list$($1767, $1751, $1754);
                                                                    var _state$31 = (() => {
                                                                        var $1770 = _state$25;
                                                                        var $1771 = _area$30;
                                                                        let _state$32 = $1770;
                                                                        let _coord$31;
                                                                        while ($1771._ === 'List.cons') {
                                                                            _coord$31 = $1771.head;
                                                                            var $1770 = Web$Kaelin$Skill$update_state$(_state$32, $1751, _coord$31, _effect$24);
                                                                            _state$32 = $1770;
                                                                            $1771 = $1771.tail;
                                                                        }
                                                                        return _state$32;
                                                                    })();
                                                                    var $1768 = Web$Kaelin$Skills$skill_use$aux$(_state$31);
                                                                    var $1760 = $1768;
                                                                    break;
                                                                case 'Web.Kaelin.Skill.Effect.status':
                                                                    var $1772 = self.area;
                                                                    var _area$30 = Web$Kaelin$Skill$area$to_list$($1772, $1751, $1754);
                                                                    var _state$31 = (() => {
                                                                        var $1775 = _state$25;
                                                                        var $1776 = _area$30;
                                                                        let _state$32 = $1775;
                                                                        let _coord$31;
                                                                        while ($1776._ === 'List.cons') {
                                                                            _coord$31 = $1776.head;
                                                                            var $1775 = Web$Kaelin$Skill$update_state$(_state$32, $1751, _coord$31, _effect$24);
                                                                            _state$32 = $1775;
                                                                            $1776 = $1776.tail;
                                                                        }
                                                                        return _state$32;
                                                                    })();
                                                                    var $1773 = Web$Kaelin$Skills$skill_use$aux$(_state$31);
                                                                    var $1760 = $1773;
                                                                    break;
                                                            };
                                                            _state$25 = $1760;
    ...
    function Web$Kaelin$App$when$(_event$1, _state$2) {
        ...
        switch (self._) {
            case 'App.Event.init':
                ...
                switch (self._) {
                    case 'Web.Kaelin.State.game':
                        var $1783 = self.players;
                        var $1784 = self.cast_info;
                        var $1785 = self.map;
                        var $1786 = self.internal;
                        var $1787 = self.env_info;
                        var _user$13 = String$to_lower$($1781);
                        var $1788 = IO$monad$((_m$bind$14 => _m$pure$15 => {
                            var $1789 = _m$bind$14;
                            return $1789;
                        }))(App$watch$(Web$Kaelin$Constants$room))((_$14 => {
                            var $1790 = App$store$(Web$Kaelin$State$game$(_user$13, Web$Kaelin$Constants$room, $1783, $1784, $1785, $1786, $1787));
                            return $1790;
                        }));
                        var $1782 = $1788;
                        break;
            ...
            case 'App.Event.tick':
                ...
                switch (self._) {
                    ...
                    case 'Web.Kaelin.State.game':
                        var _info$12 = $1793;
                        var _state$13 = Web$Kaelin$Action$update_interface$(_info$12, ($1792), _state$2);
                        var $1796 = App$store$(Web$Kaelin$Action$update_area$(_state$13));
                        var $1794 = $1796;
                        break;
                };
                var $1780 = $1794;
            ...
            case 'App.Event.key_down':
                ...
                switch (self._) {
                    case 'Web.Kaelin.State.game':
                        ...
                        var self = ($1797 === 49);
                        if (self) {
                            var $1801 = App$store$(Web$Kaelin$Action$create_player$($1799, Web$Kaelin$Heroes$Croni$croni, _state$2));
                            var $1800 = $1801;
                        } else {
                            var $1802 = App$store$(Web$Kaelin$Action$start_cast$($1797, _state$2));
                            var $1800 = $1802;
                        };
                        var $1798 = $1800;
                        break;
            ...
            case 'App.Event.post':
                ...
                switch (self._) {
                    case 'Web.Kaelin.State.game':
                        var $1807 = self.map;
                        var self = Web$Kaelin$Event$deserialize$(String$drop$(2n, $1805));
                        switch (self._) {
                            case 'Maybe.some':
                                var $1809 = self.value;
                                var self = $1809;
                                switch (self._) {
                                    case 'Web.Kaelin.Event.user_input':
                                        var $1811 = self.player;
                                        var $1812 = self.coord;
                                        var _pos$18 = $1812;
                                        var self = _pos$18;
                                        switch (self._) {
                                            case 'Web.Kaelin.Coord.new':
                                                var _origin$21 = Web$Kaelin$Map$player$to_coord$($1804, $1807);
                                                var self = _origin$21;
                                                switch (self._) {
                                                    case 'Maybe.none':
                                                        var $1815 = App$pass;
                                                        ...
                                                        break;
                                                    case 'Maybe.some':
                                                        var $1816 = ((console.log($1811), (_$23 => {
                                                            var $1817 = App$store$(Web$Kaelin$Skill$skill_use$(_state$2));
                                                            return $1817;
                                                        })()));
                                                        var $1814 = $1816;
                                                        break;
            ...
            case 'App.Event.mouse_up':
                ...
                switch (self._) {
                    case 'Web.Kaelin.State.game':
                        var $1824 = self.user;
                        var $1825 = self.room;
                        var $1826 = self.env_info;
                        var _info$12 = $1826;
                        var self = _info$12;
                        switch (self._) {
                            case 'App.EnvInfo.new':
                                var $1828 = self.mouse_pos;
                                var self = Web$Kaelin$Coord$to_axial$($1828);
                                switch (self._) {
                                    case 'Web.Kaelin.Coord.new':
                                        var $1830 = self.i;
                                        var $1831 = self.j;
                                        var _hex$17 = Web$Kaelin$Event$serialize$(Web$Kaelin$Event$user_input$($1824, Web$Kaelin$Coord$new$($1830, $1831), Web$Kaelin$Action$walk));
                                        var $1832 = App$post$($1825, _hex$17);
                                        var $1829 = $1832;
                                        break;
                                };
                                var $1827 = $1829;
    ...
    const Web$Kaelin = (() => {
        ...
        var $1837 = App$new$(_init$2, _draw$3, _when$4);
        return $1837;
    })();
    return {
