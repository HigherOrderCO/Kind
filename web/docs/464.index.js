...
module.exports = (function() {
    ...
    function Buffer32$new$(_depth$1, _array$2) {
        var $102 = u32array_to_buffer32(_array$2);
        return $102;
    };
    ...
    function Array$alloc$(_depth$2, _x$3) {
        var self = _depth$2;
        if (self === 0n) {
            var $107 = Array$tip$(_x$3);
            var $106 = $107;
        } else {
            var $108 = (self - 1n);
            var _half$5 = Array$alloc$($108, _x$3);
            var $109 = Array$tie$(_half$5, _half$5);
            var $106 = $109;
        };
        return $106;
    };
        ...
        while (true) {
            ...
            var R = (() => {
                ...
                switch (self._) {
                    case 'Word.o':
                        var $110 = self.pred;
                        var $111 = Word$bit_length$go$($110, Nat$succ$(_c$3), _n$4);
                        return $111;
                    case 'Word.i':
                        var $112 = self.pred;
                        var $113 = Word$bit_length$go$($112, Nat$succ$(_c$3), Nat$succ$(_c$3));
                        return $113;
                    case 'Word.e':
                        var $114 = _n$4;
                        return $114;
    ...
    function Word$bit_length$(_word$2) {
        var $115 = Word$bit_length$go$(_word$2, 0n, 0n);
        return $115;
    };
    ...
    function U32$bit_length$(_size$1) {
        ...
        switch ('u32') {
            case 'u32':
                var $117 = u32_to_word(self);
                var $118 = Word$bit_length$($117);
                var $116 = $118;
                break;
        };
        return $116;
    ...
    function Word$shift_left1$aux$(_word$2, _prev$3) {
        ...
        switch (self._) {
            case 'Word.o':
                ...
                var self = _prev$3;
                if (self) {
                    var $122 = Word$i$(Word$shift_left1$aux$($120, Bool$false));
                    var $121 = $122;
                } else {
                    var $123 = Word$o$(Word$shift_left1$aux$($120, Bool$false));
                    var $121 = $123;
                };
                var $119 = $121;
                break;
            case 'Word.i':
                ...
                var self = _prev$3;
                if (self) {
                    var $126 = Word$i$(Word$shift_left1$aux$($124, Bool$true));
                    var $125 = $126;
                } else {
                    var $127 = Word$o$(Word$shift_left1$aux$($124, Bool$true));
                    var $125 = $127;
                };
                var $119 = $125;
                break;
    ...
    function Word$shift_left1$(_word$2) {
        ...
        switch (self._) {
            case 'Word.o':
                var $130 = self.pred;
                var $131 = Word$o$(Word$shift_left1$aux$($130, Bool$false));
                var $129 = $131;
                break;
            case 'Word.i':
                var $132 = self.pred;
                var $133 = Word$o$(Word$shift_left1$aux$($132, Bool$true));
                var $129 = $133;
                break;
            case 'Word.e':
                var $134 = Word$e;
        ...
        while (true) {
            ...
            var R = (() => {
                ...
                switch (self._) {
                    case 'Word.o':
                        var $169 = self.pred;
                        var $170 = Word$mul$go$($169, Word$shift_left1$(_b$4), _acc$5);
                        return $170;
                    case 'Word.i':
                        var $171 = self.pred;
                        var $172 = Word$mul$go$($171, Word$shift_left1$(_b$4), Word$add$(_b$4, _acc$5));
                        return $172;
                    case 'Word.e':
                        var $173 = _acc$5;
                        return $173;
    ...
    function Word$to_zero$(_word$2) {
        ...
        switch (self._) {
            case 'Word.o':
                var $175 = self.pred;
                var $176 = Word$o$(Word$to_zero$($175));
                var $174 = $176;
                break;
            case 'Word.i':
                var $177 = self.pred;
                var $178 = Word$o$(Word$to_zero$($177));
                var $174 = $178;
                break;
            case 'Word.e':
                var $179 = Word$e;
    ...
    function Word$mul$(_a$2, _b$3) {
        var $180 = Word$mul$go$(_a$2, _b$3, Word$to_zero$(_a$2));
        return $180;
    };
    ...
    function String$cons$(_head$1, _tail$2) {
        var $183 = (String.fromCharCode(_head$1) + _tail$2);
        return $183;
    };
    ...
    function String$repeat$(_xs$1, _n$2) {
        ...
        if (self === 0n) {
            ...
            var $186 = (self - 1n);
            var $187 = (_xs$1 + String$repeat$(_xs$1, $186));
            var $184 = $187;
        };
        return $184;
    };
    ...
    function Web$Kind$component$header_tab$(_is_active$1, _title$2) {
        ...
        if (self) {
            var $190 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("margin-right", "30px"), List$cons$(Pair$new$("border-style", "none none solid none"), List$cons$(Pair$new$("border-color", Web$Kind$constant$secondary_color), List$cons$(Pair$new$("font-size", "18px"), List$cons$(Pair$new$("cursor", "pointer"), List$cons$(Pair$new$("width", "70px"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("justify-content", "center"), List$nil))))))))), List$cons$(DOM$text$(_title$2), List$nil));
            var $189 = $190;
        } else {
            var $191 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("margin-right", "10px"), List$cons$(Pair$new$("font-size", "18px"), List$cons$(Pair$new$("cursor", "pointer"), List$cons$(Pair$new$("width", "70px"), List$cons$(Pair$new$("margin-bottom", "2px"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("justify-content", "center"), List$nil)))))))), List$cons$(DOM$text$(_title$2), List$nil));
            var $189 = $191;
        };
        return $189;
    };
    ...
    function Web$Kind$component$header_tabs$(_page$1) {
        ...
        var _tabs$4 = (() => {
            ...
            while ($228._ === 'List.cons') {
                _title$4 = $228.head;
                var $227 = List$cons$(Web$Kind$component$header_tab$(Web$Kind$helper$is_current$(_title$4, _page$1), _title$4), _tabs$5);
                _tabs$5 = $227;
                $228 = $228.tail;
            }
            return _tabs$5;
        })();
        var $225 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("padding-left", "20%"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("flex-direction", "row"), List$nil)))), _tabs$4);
        return $225;
    };
    ...
    function Web$Kind$component$header$(_page$1) {
        ...
        var $229 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$nil), List$cons$(DOM$node$("h2", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("margin-top", "40px"), List$cons$(Pair$new$("font-family", "verdana"), List$cons$(Pair$new$("text-align", "center"), List$nil)))), List$cons$(DOM$text$("KIND language"), List$nil)), List$cons$(_line$3, List$cons$(Web$Kind$component$header_tabs$(_page$1), List$nil))));
        return $229;
    };
    ...
    function Web$Kind$component$body_container$(_ele$1) {
        var $230 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("margin", "40px 20% 40px 20%"), List$cons$(Pair$new$("flex", "1"), List$nil))), _ele$1);
        return $230;
    };
    ...
    function Web$Kind$component$list$(_items$1) {
        ...
        var _li$3 = (() => {
            ...
            let _li$4 = $233;
            let _item$3;
            while ($234._ === 'List.cons') {
                _item$3 = $234.head;
                var $233 = List$cons$(DOM$node$("li", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("margin-top", "5px"), List$nil)), List$cons$(_item$3, List$nil)), _li$4);
                _li$4 = $233;
                $234 = $234.tail;
            }
            return _li$4;
        })();
        var $231 = DOM$node$("ul", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("list-style-type", "none"), List$nil)), _li$3);
        return $231;
    };
    const Web$Kind$component$list = x0 => Web$Kind$component$list$(x0);

    function Web$Kind$component$link_white$(_txt$1, _href$2) {
        var $235 = DOM$node$("a", Map$from_list$(List$cons$(Pair$new$("href", _href$2), List$cons$(Pair$new$("target", "_blank"), List$nil))), Map$from_list$(List$cons$(Pair$new$("font-size", Web$Kind$constant$p_tag_size), List$cons$(Pair$new$("color", "white"), List$cons$(Pair$new$("cursor", "pointer"), List$nil)))), List$cons$(DOM$text$(_txt$1), List$nil));
        return $235;
    };
    ...
    const Web$Kind$component$footer = (() => {
        ...
        var $236 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("height", "170px"), List$cons$(Pair$new$("margin-bottom", "0px"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("flex-direction", "column"), List$cons$(Pair$new$("color", "white"), List$nil)))))), List$cons$(_join_us$1, List$cons$(_msg_footer$2, List$nil)));
        return $236;
    })();
    ...
    function Web$Kind$component$game_card$(_src$1, _title$2, _path$3) {
        ...
        var $241 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("height", "120px"), List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("flex-direction", "column"), List$nil)))), List$cons$(_banner$4, List$cons$(_title$5, List$nil)));
        return $241;
    };
    ...
    const Web$Kind$content_apps = List$cons$(Web$Kind$component$game_card$(Web$Kind$img$banner_template, "Senhas", "Web.Senhas"), List$cons$(Web$Kind$component$game_card$(Web$Kind$img$banner_template, "TicTacToe", "Web.TicTacToe"), List$nil));
    const Web$Kind$draw_page_apps = (() => {
        var _line$1 = (_txt$1 => {
            var $243 = DOM$node$("p", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("font-size", Web$Kind$constant$p_tag_size), List$nil)), List$cons$(DOM$text$(_txt$1), List$nil));
            return $243;
        });
        var _line_break$2 = DOM$node$("p", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("font-size", Web$Kind$constant$p_tag_size), List$nil)), List$cons$(DOM$node$("br", Map$from_list$(List$nil), Map$from_list$(List$nil), List$nil), List$nil));
        var _span$3 = (_txt$3 => {
            var $244 = DOM$node$("span", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("font-size", Web$Kind$constant$p_tag_size), List$nil)), List$cons$(DOM$text$(_txt$3), List$nil));
            return $244;
        });
        var _span_bold$4 = (_txt$4 => {
            var $245 = DOM$node$("span", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("font-weight", "bold"), List$cons$(Pair$new$("font-size", Web$Kind$constant$p_tag_size), List$nil))), List$cons$(DOM$text$(_txt$4), List$nil));
            return $245;
        });
        var _games$5 = DOM$node$("div", Map$from_list$(List$cons$(Pair$new$("id", "game-container"), List$nil)), Map$from_list$(List$nil), List$cons$(Web$Kind$component$title$("Games"), List$cons$(DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("justify-content", "space-evenly"), List$nil))), Web$Kind$content_apps), List$nil)));
        var $242 = DOM$node$("div", Map$from_list$(List$cons$(Pair$new$("id", "page-apps"), List$nil)), Map$from_list$(List$cons$(Pair$new$("display", "flex"), List$cons$(Pair$new$("flex-direction", "column"), List$cons$(Pair$new$("justify-content", "space-between"), List$cons$(Pair$new$("height", "100%"), List$nil))))), List$cons$(Web$Kind$component$header$(Web$Kind$Page$apps), List$cons$(Web$Kind$component$body_container$(List$cons$(_games$5, List$nil)), List$cons$(Web$Kind$component$footer, List$nil))));
        return $242;
    })();
    ...
    function Web$Kind$draw_page$(_page$1) {
        ...
        switch (self._) {
            case 'Web.Kind.Page.home':
                var $247 = Web$Kind$draw_page_home;
                var $246 = $247;
                break;
            case 'Web.Kind.Page.apps':
                var $248 = Web$Kind$draw_page_apps;
                var $246 = $248;
                break;
        };
        return $246;
    ...
    function IO$bind$(_a$3, _f$4) {
        ...
        switch (self._) {
            ...
            case 'IO.ask':
                ...
                var $255 = self.param;
                var $256 = self.then;
                var $257 = IO$ask$($254, $255, (_x$8 => {
                    var $258 = IO$bind$($256(_x$8), _f$4);
                    return $258;
                }));
                var $251 = $257;
                break;
    ...
    const Web$Kind = (() => {
        ...
        var _draw$2 = (_state$2 => {
            ...
            switch (self._) {
                case 'Web.Kind.State.new':
                    var $266 = self.page;
                    var $267 = Web$Kind$draw_page$($266);
                    var $265 = $267;
                    break;
            };
            return $265;
        ...
        var $264 = App$new$(_init$1, _draw$2, _when$3);
        return $264;
    })();
    return {
