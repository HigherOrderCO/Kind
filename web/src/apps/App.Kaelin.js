module.exports = (function() {
    ...
    const App$Kaelin$init = App$Store$new$(0n, 0n);
    ...
    const App$Kaelin$draw = x0 => App$Kaelin$draw$(x0);
    ...
    function App$Kaelin$when$(_event$1, _state$2) {
        var self = _event$1;
        switch (self._) {
            case 'App.Event.init':
    ...
    const App$Kaelin$when = x0 => x1 => App$Kaelin$when$(x0, x1);
    ...
    const App$Kaelin$tick = App$no_tick;

    function App$Kaelin$post$(_time$1, _room$2, _addr$3, _data$4, _global_state$5) {
        var $154 = (_global_state$5 + 1n);
        return $154;
    };
    const App$Kaelin$post = x0 => x1 => x2 => x3 => x4 => App$Kaelin$post$(x0, x1, x2, x3, x4);
    const App$Kaelin = App$new$(App$Kaelin$init, App$Kaelin$draw, App$Kaelin$when, App$Kaelin$tick, App$Kaelin$post);
    return {
        'App.new': App$new,
        'Pair.new': Pair$new,
        ...
        'App.Kaelin.init': App$Kaelin$init,
        'DOM.node': DOM$node,
        'BitsMap': BitsMap,
        'Map': Map,
        ...
        'Nat.show': Nat$show,
        'App.Kaelin.draw': App$Kaelin$draw,
        'IO': IO,
        'Pair.fst': Pair$fst,
        ...
        'Nat.add': Nat$add,
        'App.Kaelin.when': App$Kaelin$when,
        'App.no_tick': App$no_tick,
        'App.Kaelin.tick': App$Kaelin$tick,
        'App.Kaelin.post': App$Kaelin$post,
