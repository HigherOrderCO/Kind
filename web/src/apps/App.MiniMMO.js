module.exports = (function() {
    ...
    function BitsMap$values$go$(_xs$2, _list$3) {
        ...
        switch (self._) {
            case 'BitsMap.tie':
                ...
                var _list1$8 = BitsMap$values$go$($65, _list0$7);
                var _list2$9 = BitsMap$values$go$($66, _list1$8);
                var $67 = _list2$9;
                var $63 = $67;
                break;
            case 'BitsMap.new':
    ...
    function Map$values$(_xs$2) {
        var $72 = BitsMap$values$go$(_xs$2, List$nil);
        return $72;
    };
    ...
    function App$MiniMMO$draw$(_state$1) {
        ...
        var _avatars$3 = (() => {
            ...
            let _avatars$4 = $136;
            let _player$3;
            while ($137._ === 'List.cons') {
                _player$3 = $137.head;
                var _style$5 = Map$from_list$(List$cons$(Pair$new$("position", "absolute"), List$cons$(Pair$new$("left", (Nat$show$((BigInt((() => {
                    var self = _player$3;
                    switch (self._) {
                ...
                var $136 = List$cons$(DOM$node$("div", Map$from_list$(List$nil), _style$5, List$cons$(DOM$text$("X"), List$nil)), _avatars$4);
                _avatars$4 = $136;
                $137 = $137.tail;
            }
            return _avatars$4;
        })();
        var $134 = DOM$node$("div", Map$from_list$(List$nil), Map$from_list$(List$nil), _avatars$3);
        return $134;
    };
