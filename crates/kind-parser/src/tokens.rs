//! Description of all of the tokens of the language.
//! Some keywords are soft keywords so we just check
//! the identifier.

use core::fmt;
use kind_span::Symbol;
...
pub enum Token {
    ...
    Help(Symbol),    // ?help
    LowerId(Symbol), // lower
    UpperId(Symbol), // Upper
...
impl fmt::Display for Token {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Token::Help(text) => write!(f, "?{}", text.to_str()),
            Token::LowerId(id) => write!(f, "{}", id.to_str()),
            Token::UpperId(main) => write!(f, "{}", main.to_str()),
            Token::Char(c) => write!(f, "'{}'", c),
            Token::Str(s) => write!(f, "\"{}\"", s.to_str()),
            ...
            Token::Hash => write!(f, "#"),
            Token::Comment(true, comment) => write!(f, "docstring '{}'", comment.to_str()),
            Token::Comment(false, comment) => write!(f, "comment '{}'", comment.to_str()),
