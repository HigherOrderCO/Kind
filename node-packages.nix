...
let
  sources = {
    ...
    "gulp-typescript-6.0.0-alpha.1" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/gulp-typescript/-/gulp-typescript-6.0.0-alpha.1.tgz";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."gulp-typescript-6.0.0-alpha.1" // {
        dependencies = [
    ...
    meta = {
      description = "";
      homepage = https://github.com/moonad/formality;
      license = "MIT";
    };
    production = false;
    bypassCache = true;
