...
idea, which he calls "inductive types with conditions", to generalize higher
inductive types (HITs). He also proposes a nice syntax to represent the concept.
I'm a simpler man, so I just call this "smart constructors".

We don't have a syntax for smart constructors on Kind yet. But the surprising
