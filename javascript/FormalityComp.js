...
module.exports = {
  ...
  hs: function(new_format_file, main) {
    ...
    var prim_funcs = {
      ...
      "Nat.ltn"     : "(\\a->(\\b->((if (a::Integer)<b then 1 else 0)::Integer)))",
      "Nat.lte"     : "(\\a->(\\b->((if (a::Integer)<=b then 1 else 0)::Integer)))",
      "Nat.eql"     : "(\\a->(\\b->((if (a::Integer)==b then 1 else 0)::Integer)))",
      "Nat.gte"     : "(\\a->(\\b->((if (a::Integer)>=b then 1 else 0)::Integer)))",
      "Nat.gtn"     : "(\\a->(\\b->((if (a::Integer)>b then 1 else 0)::Integer)))",
      "U32.add"     : "(\\a->(\\b->(a+b)::Word32))",
      "U32.sub"     : "(\\a->(\\b->(a-b)::Word32))",
      "U32.mul"     : "(\\a->(\\b->(a*b)::Word32))",
      "U32.ltn"     : "(\\a->(\\b->((if (a::Word32)<b then 1 else 0)::Word32)))",
      "U32.lte"     : "(\\a->(\\b->((if (a::Word32)<=b then 1 else 0)::Word32)))",
      "U32.eql"     : "(\\a->(\\b->((if (a::Word32)==b then 1 else 0)::Word32)))",
      "U32.gte"     : "(\\a->(\\b->((if (a::Word32)>=b then 1 else 0)::Word32)))",
      "U32.gtn"     : "(\\a->(\\b->((if (a::Word32)>b then 1 else 0)::Word32)))",
      "U16.add"     : "(\\a->(\\b->(a+b)::Word16))",
      "U16.sub"     : "(\\a->(\\b->(a-b)::Word16))",
      "U16.mul"     : "(\\a->(\\b->(a*b)::Word16))",
      "U16.ltn"     : "(\\a->(\\b->((if (a::Word16)<b then 1 else 0)::Word16)))",
      "U16.lte"     : "(\\a->(\\b->((if (a::Word16)<=b then 1 else 0)::Word16)))",
      "U16.eql"     : "(\\a->(\\b->((if (a::Word16)==b then 1 else 0)::Word16)))",
      "U16.gte"     : "(\\a->(\\b->((if (a::Word16)>=b then 1 else 0)::Word16)))",
      "U16.gtn"     : "(\\a->(\\b->((if (a::Word16)>b then 1 else 0)::Word16)))",
