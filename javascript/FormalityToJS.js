...
var prim_funcs = {
  ...
  "VoxModel.set_pos" : [3, a=>b=>c=>`(${c}.buffer[${a}*2]=${b},${c})`],
  "VoxModel.get_pos" : [2, a=>b=>`(${b}.buffer[${a}*2])`],
  "VoxModel.set_col" : [3, a=>b=>c=>`(${c}.buffer[${a}*2+1]=${b},${c})`],
  "VoxModel.get_col" : [2, a=>b=>`(${b}.buffer[${a}*2+1])`],
  "String.eql"       : [2, a=>b=>`${a}===${b}`],
  "String.concat"    : [2, a=>b=>`${a}+${b}`],
  "Equal.cast"       : [1, a=>a],
  "Pos32.new"        : [3, a=>b=>c=>`(0|${a}|(${b}<<12)|(${c}<<24))`],
  "Pos32.get_x"      : [1, a=>`(${a}&0x7FF)`],
  "Pos32.get_y"      : [1, a=>`((${a}>>>12)&0x7FF)`],
