...
is-free lvl       (go0 path) (dup cpy0 cpy1 term body) = is-free lvl path term
is-free lvl       (go1 path) (dup cpy0 cpy1 term body) = diff path cpy0 ∧ diff path cpy1 ∧ is-free lvl path body
...
well-scoped (dup cpy0 cpy1 term body) = well-scoped term ∧ well-scoped body ∧ diff cpy0 cpy1 ∧ is-free 1 cpy0 body ∧ is-free 1 cpy1 body
